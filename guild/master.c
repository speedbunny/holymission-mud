...
void reset(int arg) {
  ...
  gd_info=({
    ...
    ({ "thief",         "brainsprain",  30,     0,   40, 10,    2,  "T"}),
    ({ "druid",       "meecham",  30,     0,   42,  8,    2,  "D"}),
    ({ "fighter",      "sargon",  30,     0,   42,  8,    2,  "F"}),
    ({ "jedi",         "mangla",  30,     1,   39, 11,    2,  "J"}),
    ({ "mage",          "llort",  30,     1,   42,  8,    2,  "W"}),
    ({ "bard",           "turbo",  30,     0,   42,  8,    2,  "B"}),
    ({ "monk",         "sauron",  30,     1,   42,  8,    2,  "M"}),
    ({ "ninja",      "tatsuo",    30,     0,   40, 10,    2,  "N"}),
    ({ "summoner",     "redsexy",  30,    0,   42,  8,    2,  "S"}),
    ({ "vagabond", "nae",       30,     1,   42,  8,    2,  "V"}),
    ({ "barbarian",  "darastor",  30,     1,   42,  8,    2,  "*"}),
