...
void reset( int tick )
{
   ...
   set_player_help(
      "By means of this spell the wizard hurls a blast of acid onto\n"+
      "his/her opponent, causing flesh to ooze away!"
   );
}
...
void release_spell( string arg, int act_skill, int max_skill )
{
   ...
   if ( check_success( act_skill, max_skill ) ) {
      ...
      if ( dam == 0 ) {
         ...
         write( "oozing away chunks of flesh !\n" );
         say( "oozing away chunks of flesh !\n", oppo );
         tell_object( oppo, "oozing away chunks of flesh !\n" );
      }
      else {
