...
string *dlist,*mlist;
   ...
   if(storeynr==2) storeyparts = 6;
   if(storeynr==3) storeyparts = 4;
...
set_groom(str) {
   groom=str;
   set_long("A four storey high wedding cake from Candy's confectioner's shop. \n"
          + "Specially created for the most happy marriage of " + cap(bride) + " and " + cap(groom) + ".\n"
          + "It's four storeys high and so detailed that you have to look \n"
