...
query_defines(gd) {
 ...
 ({ "Volunteer",   "Simple Gardner"		})		 /* 1 */
  ...
  case 4 : /* Jedi guild, Kelly, gender not supported , yet */

  return ({
  ({ 0, 	"Apprentice Wizard"			}),    /* 30 */
  ({ "Lord",	"Jedimaster"			}),
  ({ "Lord",	"minor Jedimaster"			}),
  ({ "Earl",	"experienced brainstormer"		}),
  ({ "Earl",	"brainstormer"			}),
  ({ "Earl",	"minor brainstormer"		}),    /* 25 */
  ({ "Viscount","experienced Jedi"			}),
  ({ "Viscount","Jedi"				}),
  ({ "Vicount", "minor Jedi"			}),
  ({ "Count",	"Jedi contender"			}),
  ({ "Count",	"apprentice Jedi"			}),    /* 20 */
  ({ "Count",	"Jedi trainee"			}),
  ({ "Duke",	"training Jedi"			}),
  ({ 0, 	"hopeful contender"			}),
  ({ 0, 	"hopeful contender",		}),	
  ...
  ({ 0, 	"lower contender",			}),
  ({ 0, 	"novice contender",			}),
  ({ 0, 	"novice contender",			}),   /* 10 */
  ({ 0, 	"student of Jedi knighthood",	}),
  ({ 0, 	"student of Jedi knighthood",	}),
  ({ 0, 	"beginning student of Jedi knighthood",}),
  ({ 0, 	"beginning student of Jedi knighthood",}),
  ({ 0, 	"hopeful novice",			}),   /* 5 */
  ({ 0, 	"hopeful novice",			}),
  ({ 0, 	"novice", 				}),
