...
void reset( int arg ) {
  ...
  long_desc = "You have come to a bare patch of muddy clay soil, the size "
    ...
    + "of ground to the east and west.\n";
  hidden_dir = ({
    ROOM_DIR + "cemetry7", "north",
    ROOM_DIR + "grave10", "west",
    ROOM_DIR + "grave12", "east",
  });
  no_obvious_msg = "The gravel path lies directly north of this place.\n";
  items=({
