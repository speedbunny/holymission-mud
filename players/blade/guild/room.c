...
#define DIR             "guild/master"->query_dir(1)
...
status _north() {
  //    if (this_player()->query_guild()!=1)
    if(!present("thiefsoul",this_player()))
        ...
        this_player()->move_player("north#players/blade/guild/tavern");
    return 1;
}
status _south() {
  //    if (this_player()->query_guild()!=1)
    if(!present("thiefsoul",this_player()))
      ...
      this_player()->move_player("north#players/blade/guild/temple");
  return 1;
}
...
status _west() {
  //    if (this_player()->query_guild()!=1)
    if(!present("thiefsoul",this_player()))
      ...
      this_player()->move_player("west#players/blade/guild/fence");
  return 1;
}
