/*  Code blatantly stolen from Padrone, */
/*  one of the best coders in existence */
...
handle_say(str) {
    ...
    if (!hero || !present(hero, this_object()))
        ...
        say("The general says: " + who + ", " + hero_name + 
            " and I are discussing important matters, please be quiet.\n");
    }
