...
"Noises come from all around you, and you feel watched.  A large\n"+
"palisade lies to the east.\n";

   dest_dir=({
            F2PATH+"forest57.c","south",
            F2PATH+"forest55.c","north",
	    F2PATH+"forest59.c","west",
     });
   items=({ 
