...
"some of the larger stones.  It is unnaturally quiet, and a dead-end looms\n"+
"up high before you.  Cart tracks extend across the room going southwest.\n";
   dest_dir=({
	    L1PATH+"mt20.c",  "southwest",
	  });
   items=({ 
