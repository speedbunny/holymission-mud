...
#include "/players/blade/area/room_functs.c"
...
"You are on top of a narrow wooden platform placed behind palisade.  Guards\n"+
 ...
 "to walk or risk falling off.  The platform continues east and bends north\n"+
  "along the palisade.\n";
   dest_dir=({
            CAMPPATH+"palisade2.c",   "west",
	    CAMPPATH+"palisade4.c",   "north",
                 });
   items=({ 
 ...
 move_object(clone_object(MPATH+"wolfen_guard"),this_object());
