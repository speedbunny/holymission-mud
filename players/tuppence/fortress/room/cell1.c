...
void reset(int arg) {
	...
	long_desc= "You have entered a cell. Skeletons hang from the walls in shackles.\n"+
	"You can smell the rotten bodies that are laying around. Death floats\n"+
...
clone_list = ({
1, 2, "prisoner", "players/tuppence/fortress/monster/prisoner", 0,
});
	dest_dir= 
	({
	  FROOM+ "dun4","west",
    ...
    ::reset(arg); // This line makes the clone list work :)
