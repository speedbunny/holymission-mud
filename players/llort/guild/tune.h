...
#define         TYPE_OF_ROBE            "guild/robe/armour"


/* Time how often the SP for invis are decremented. */
#define		CHK_SP_FOR_INVIS	30	/* given in secs. */
...
#define 	TIME_LIGHT		600	/* in secs */

/* Time how long the 'lasting light' will last */
#define 	TIME_LLIGHT		1000  	/* in secs */
...
/* Time * Level is the time for the strength */
#define 	STRENGTH_TIME         10      /* in secs */
...
#define 	STRENGTH_LVL		12
#define		STRENGTH_SP		150
...
#define         CRUSH_DAM               (80+random(65))  /*raised from 60+45*/
...
#define		HOLD_PLAYER		random((TPIN+1)*5/ob->query_level())
