...
give(arg) {
    object heart, seed;
    string what,who;
    sscanf(arg, "%s to %s", what, who);
    if( ( what == "heart" || what == "black heart") &&
      ( who == "woman" || who == "goddess" ||
	who == "gaiea") ) {
	/* Nylakoorub: 060396 - made it so that 'black heqart' and 'heart'
	  works, to giving to woman - using sscanf for better arg passing */
