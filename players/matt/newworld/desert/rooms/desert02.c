...
reset(arg) {
  ...
  dest_dir = ({
    NWDESERT + "rooms/waste01", "west",
    NWDESERT + "rooms/desert01", "east",
    NWDESERT + "rooms/desert03", "north",
    NWDESERT + "rooms/waste02", "northwest",
    NWDESERT + "rooms/shadow01", "southwest",
  });
  ...
  clone_list = ({
    1, 3, "beetle", NWDESERT + "monsters/dungbeetle", 0,
  });
  ::reset(arg);
