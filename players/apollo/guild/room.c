/* 4-9-96 Apollo: Totally redid this room to include new coding style
   and legend levels. */
...
void reset(int arg) {
    ...
    dest_dir=({
      "/players/apollo/guild/rooms/camp6", "east",
//      "/players/apollo/guild/rooms/training", "west",
    });
...
*/
    ...
    "sys/chatd"->do_chat( 11, "<= Barbarian => Apollo welcomes " +
...
int guild_info() {
    TP->more_string(read_file("/players/apollo/guild/TEXT/help.txt"));
    return 1;
}
