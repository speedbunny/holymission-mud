...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/shore24", "north",
        "players/apollo/area2/rooms/shore15", "west",
        "players/apollo/area2/rooms/entrance", "northeast",
        "players/apollo/area2/rooms/forest09", "southwest",
           }); 
