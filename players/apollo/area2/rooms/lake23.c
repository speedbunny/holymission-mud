...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/lake22", "west",
        "players/apollo/area2/rooms/lake30", "northwest"
           }); 
  ...
  items = ({
	...
	"shore", "You see the shore to the north, south, east, and to the \n" +
		 "southwest. Perhaps you swim in that direction",
	});
  ...
  swim(str) {
    if (!str || str=="west" || str=="northeast" || str=="southeast" ||
	str=="northwest") {
	...
	this_player()->move_player("north#/players/apollo/area2/rooms/shore31");
      }	 
    if (str=="south") {
	write("You start to swim southward towards the shore. \n");
	this_player()->move_player("south#/players/apollo/area2/rooms/shore15");
      }
    if (str=="east") {
	write("You start to swim eastward towards the shore. \n");
	this_player()->move_player("east#/players/apollo/area2/rooms/shore24");
      }
    if (str=="southwest") {
	write("You start to swim southwestward towards the shore. \n");
	this_player()->move_player("southwest#/players/apollo/area2/rooms/shore14");
      }
    return 1;
  }
