...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/shore27", "north",
        "players/apollo/area2/rooms/shore20", "east",
        "players/apollo/area2/rooms/forest18", "west",
        "players/apollo/area2/rooms/shore10", "southwest",
        "players/apollo/area2/rooms/forest26", "northwest"
           }); 
  ...
  swim(str) {
	...
	this_player()->move_player("south#/players/apollo/area2/rooms/lake11");
      }
    if (str=="southeast") {
	write("You start to swim southeastward out into the lake. \n");
	write("You can see much clearer now that you are in the lake. \n");
	this_player()->move_player("southeast#/players/apollo/area2/rooms/lake12");
      }
    return 1;
  }
