...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/mountain46", "north",
        "players/apollo/area2/rooms/forest33", "south",
        "players/apollo/area2/rooms/forest41", "east",
	"players/apollo/area2/rooms/forest34", "southeast"
           }); 
