...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/shore24", "south",
        "players/apollo/area2/rooms/shore31", "west",
        "players/apollo/area2/rooms/entrance", "southeast",
        "players/apollo/area2/rooms/forest39", "northwest"
           }); 
