...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/forest33", "north",
        "players/apollo/area2/rooms/forest17", "south",
        "players/apollo/area2/rooms/forest26", "east",
	"players/apollo/area2/rooms/forest34", "northeast",
        "players/apollo/area2/rooms/forest18", "southeast",
           }); 
