...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/forest08", "north",
        "players/apollo/area2/rooms/forest04", "east",
        "players/apollo/area2/rooms/forest02", "west",
        "players/apollo/area2/rooms/forest09", "northeast",
        "players/apollo/area2/rooms/shore07", "northwest"
           }); 
  ...
  move_object((clone_object("players/apollo/area2/monsters/bee")),
	this_object());
