...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/forest35", "north",
        "players/apollo/area2/rooms/shore19", "south",
        "players/apollo/area2/rooms/forest26", "west",
        "players/apollo/area2/rooms/shore36", "northeast",
        "players/apollo/area2/rooms/shore20", "southeast",
        "players/apollo/area2/rooms/forest18", "southwest",
        "players/apollo/area2/rooms/forest34", "northwest"
           }); 
  ...
  swim(str) {
	...
	this_player()->move_player("east#/players/apollo/area2/rooms/lake28");
      }
    return 1;
  }
