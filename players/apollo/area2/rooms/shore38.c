...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/forest44", "north",
        "players/apollo/area2/rooms/forest39", "east",
        "players/apollo/area2/rooms/shore37", "west",
        "players/apollo/area2/rooms/shore31", "southeast",
        "players/apollo/area2/rooms/forest43", "northwest"
           }); 
  ...
  items = ({
	...
	"lake", "You see a lake covered in a dense fog that prevents you \n" +
		"from seeing very far to your south and southwest. Perhaps \n" +
  ...
  swim(str) {
	...
	this_player()->move_player("south#/players/apollo/area2/rooms/lake30");
      }
    if (str=="southwest") {
	write("You start to swim southwestward out into the lake. \n");
	write("You can see much clearer now that you are in the lake. \n");
	this_player()->move_player("southwest#/players/apollo/area2/rooms/lake29");
      }
    return 1;
  }
