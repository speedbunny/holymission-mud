...
reset(arg){        
  ...
  dest_dir = ({
        "players/apollo/area2/rooms/shore36", "south",
        "players/apollo/area2/rooms/forest43", "east",
        "players/apollo/area2/rooms/shore37", "southeast",
        "players/apollo/area2/rooms/forest35", "southwest",
           }); 
  ...
  clone_list = ({ 1, 6, "ant", "players/apollo/area2/monsters/ant", 0, });
