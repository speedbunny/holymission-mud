...
reset(arg){        
  ...
  long_desc = 
	...
	"covered in something, and there is a sweet smell in the air. To the \n" +
	"north you hear the snorting of much large full grown bears! \n";

  dest_dir = ({
	"players/apollo/area2/rooms/forest47", "north",
        "players/apollo/area2/rooms/forest39", "southwest",
           }); 
