  ...
  dest_dir = ({
	"players/apollo/thieves/rooms/sewer07", "north",
	"players/apollo/thieves/rooms/sewer10", "east",
	"players/apollo/thieves/rooms/sewer33", "west",
             }); 
  ...
  open(str) {
	...
	if (str=="grate") {
		...
		this_player()->move_player("up#/room/clearing");
	  }
