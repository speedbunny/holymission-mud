  ...
  dest_dir = ({
	"players/apollo/thieves/rooms/sewer09", "north",
	"players/apollo/thieves/rooms/sewer19", "east",
	"players/apollo/thieves/rooms/sewer18", "west",
             }); 
  ...
  open(str) {
	...
	if (str=="grate") {
		...
		this_player()->move_player("up#/room/vill_shore");
	  }
  ...
  fcn_read(str) {
	...
	if (str=="sign") {
		write("The Junction between the Main Road and Eastroad is up. \n");
	    return 1;
	  }
    }
