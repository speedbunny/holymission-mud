...
dest_dir = ({
        "players/apollo/thieves/rooms/church", "north",
        "players/apollo/thieves/rooms/sewer14", "east",
        "players/apollo/thieves/rooms/sewer12", "west",
           }); 
...
smell = "You smell decomposed flesh from dead corpses";
	...
	move_object((clone_object("players/apollo/thieves/monsters/rat.c")), 
		this_object());
