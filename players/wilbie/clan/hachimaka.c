...
void long()
{
   printf("This Crimson Headband is adorned with a brilliant\n"
          ...
          "symbolizes your affliation with Clan Inquisitors of\n"
...
string extra_look()
{
  ...
  guild = MEMBERS[rname];
 if (!guild || guild == " ") guild = "Kohai";

  mesg = sprintf("%s ranks as %s in the Clan Sunsu of Clan Inquisitors",
