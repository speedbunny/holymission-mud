...
object board;
   ...
   transfer( clone_object("/boards/private_boards/wilbie_area"), this_object() );
  ...
  smell="It smells like dead things";
   dest_dir=({
   "/players/wilbie/barriers/trail2","northwest",

        "players/whisky/garden/room/house1", "southeast",
   });
  }
