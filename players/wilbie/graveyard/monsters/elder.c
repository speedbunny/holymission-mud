...
reset(arg) {
   ...
   set_long("This is an elder priestess of the Dark Order.  She looks at you "+
            "with obvious disdain and then smirks, as if you are of no "+
            "concern to her.\n");
   set_wc(4);
   set_ac(4);
   set_size(3);
