...
void reset( int arg ) {
  ...
  dest_dir = ({
    "/players/colossus/mearth/shire/quest/hall14", "east",
    "/players/colossus/mearth/shire/quest/hall12", "west",
  });
  hidden_dir = ({
    "/players/colossus/mearth/shire/quest/cell1", "south",
  });
  items = ({
    ...
    "door", "You think it will work better if you look at celldoor",
    "celldoor", "dummy door description",
  });
  ::reset( arg );

  set_door( "celldoor" );
  set_door_desc( "celldoor", "The celldoor is solidly built and has a metal lock" );
