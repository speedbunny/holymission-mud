...
void reset(int arg){
    ...
    dest_dir = ({
      "/players/colossus/mearth/shire/quest/hall14", "west",
    });
    set_light(1);
    items = ({
    ...
    MAKE_DOORS("players/colossus/mearth/shire/quest/hall15","south", "players/colossus/mearth/shire/quest/cell3","north","metal","iron","The celldoor is solidly built.\n", 1,1,1);
    if(obj_1){
	obj_1->set_closed(1);
	obj_1->set_locked(1);
