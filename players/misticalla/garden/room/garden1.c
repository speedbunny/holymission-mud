...
void reset(int arg) 
{
  ...
  if (arg) return;
     ...
     long_desc = BS(
        ...
        + "It's a lovely place where you can imagine to stay forever. "
        + "The sun is shining on your face and you immediately feel better. "
        + "There is a brown garden fence to the east and a little path "
        + "to the west.");
    items = ({ "fence","You see a big brown garden fence",
               "garden fence","You see a big brown garden fence"});
    dest_dir = ({ ROOM+"/garden4", "north",
                  "room/vill_shore3", "south",
		  ROOM+"/garden2", "west" });
}
