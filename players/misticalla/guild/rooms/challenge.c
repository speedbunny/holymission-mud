...
#define SAVE "/players/misticalla/guild/rooms/top_list"
...
void reset(int flag)
{
	...
	short_desc = "The monk challenge room";
     long_desc =
            "You have entered the sacred challenge room of the monk's guild. "+
            "It is completely empty except for a small bell "+
            "and an iron sign next to it on the wall. This room "+
            "is for monks and nuns to train in. "+
            "To fight you must ring the bell, and slay the "+
            "opponent or die.\n";
	property = "no_teleport";

	dest_dir =
	     ({
         "/players/misticalla/guild/rooms/guildroom","up",
 	     });
	save_object(SAVE);
    }
}
...
void init()
{
	...
	write("A Monk leads you out saying:\n\n"+
          "       Sorry, a challenge is already taking place.\n");
...
int my_tell(object ob)
{
    tell_object(ob,"An inner voice tells you:\n\n"+
      "Fight when fully healed and use aikido!\n");
...
int do_read(string arg)
{
    ...
    write(
      ...
      "The fight only ends when you or your opponent dies!\n"+
       "To see the bravest monks in our guild just type <toplist>.\n");
    return 1;
}
...
{
    if (mob)
        move_object(mob,"/players/misticalla/guild/guildroom");
}
...
int do_ring(string arg)
{
    ...
    {
       write("You are not ready to advance. If you think you are \n"+
             "please notify a Sage or higher wizard.\n");
