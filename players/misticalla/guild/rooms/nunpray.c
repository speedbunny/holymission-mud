...
reset(arg) {
  ...
  short_desc="Prayer Room in an Abbey";
    ...
    long_desc=
        "This is a room where nuns can pray for things. It is "+
   ...
   dest_dir = ({
             "/players/misticalla/guild/rooms/stairs2","north",
              "/players/misticalla/guild/rooms/nun2","south",
             });
 
   clone_list =
         ({1, 4, "monk", "/players/misticalla/guild/monsters/nuna", 0, });
