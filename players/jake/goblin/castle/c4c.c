...
gob->set_name("goblin chief");
gob->set_short("tower chieftan");
gob->set_alt_name("chief");
gob->set_alias("chieftan");
gob->set_size(3);
gob->set_long("This is the tower guard chief.\nHe is the commander of the tower guards of this castle.\n");
gob->set_level(20);
gob->set_hp(1000);
gob->set_al(100);
gob->set_race("goblin");
...
shield->set_ac(1);
shield->set_long("This is a guard shield.\nIt has a beautiful picture of a red dragon enblazened on it.\n");
...
dest_dir = ({
 "players/jake/goblin/castle/c4b","down",
});
}
