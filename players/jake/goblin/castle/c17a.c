...
move_object(helm,gob);
move_object(gob,this_object());
}
if (arg) return;
set_light(3);
  short_desc = "bottom floor...north west tower";
  long_desc = 
               "This is the north west guard tower.\n"
...
dest_dir = ({
         "players/jake/goblin/castle/c17","southeast",
         "players/jake/goblin/castle/c17b","up",
});
}
