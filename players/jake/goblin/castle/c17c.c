...
gob->set_name("tower chief");
gob->set_short("tower chief");
gob->set_alt_name("chief");
gob->set_alias("goblin");
gob->set_size(3);
gob->set_long("This is the goblin chief.\nHe is in charge of the second guard squadron.\n");
gob->set_level(20);
gob->set_hp(1000);
gob->set_al(100);
gob->set_race("goblin");
...
shield->set_ac(1);
shield->set_long("This is a guard shield.\nIt has a beautiful picture of a green dragon emblaxened on it.\n");
...
if (arg) return;
set_light(3);
short_desc = "c17c  Top of N/W tower  down only";
long_desc =
...
dest_dir = ({
 "players/jake/goblin/castle/c17b","down",
});
}
