/* 170794: Nokey strict typed and improvements */
#pragma strict_types
...
mixed chat_str, a_chat_str, function, type, match, function2, type2, match2;
...
void reset(int arg)
  ...
  set_light(1);
  dest_dir = ({
  "players/padrone/inside/cons","west",
  });
  short_desc = "Asmall room behind the consultation room";
  long_desc =
