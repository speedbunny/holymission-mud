...
dest_dir=({
	"players/bobo/rooms/forrest/40.c","east",
	"players/bobo/rooms/forrest/38.c","west",
	"players/bobo/rooms/forrest/50.c","north",
	"players/bobo/rooms/forrest/refract.c","south",
});
items=({
