...
dest_dir=({
	"players/bobo/rooms/forrest/30.c","east",
	"players/bobo/rooms/forrest/refract.c","west",
	"players/bobo/rooms/forrest/40.c","north",
	"players/bobo/rooms/forrest/18.c","south",
});
items=({
