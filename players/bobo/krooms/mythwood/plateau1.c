...
reset(arg) {
    ...
    dest_dir=({
		"players/bobo/krooms/mythwood/plateau","northeast",
		"players/bobo/krooms/mountains/plateau","northwest",
             });
