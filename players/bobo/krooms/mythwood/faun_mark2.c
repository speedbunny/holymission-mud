...
reset(arg) {
    ...
    dest_dir=({
		"players/bobo/krooms/mythwood/faun_druid","south",
		"players/bobo/krooms/mythwood/faun_chief","east",
		"players/bobo/krooms/mythwood/faun_mark1","west",
		"players/bobo/krooms/mythwood/faun_smith","northeast",
             });
    items=({
