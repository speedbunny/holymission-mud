...
int fall() {
    ...
    TP->hit_player(20);
    TP->MOVEP("the express way down#players/bobo/krooms/mythwood/plateau1");
    return 1;
}
...
int upwards() {
	...
	TP->MOVEP("up#players/bobo/krooms/mythwood/cloister");
        return 1;
    }
}
...
void reset(int arg) {
    ...
    dest_dir=({
		"players/bobo/krooms/mythwood/plateau1","down",
             });
    items=({
