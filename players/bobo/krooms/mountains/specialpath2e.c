#define PR "players/bobo/krooms/mountains/specialpath2w"
...
sw() {
	TP->MOVEP("southwest#players/bobo/krooms/mountains/specialpath1e");
  return 1;
}

nw() {
	TP->MOVEP("northwest#players/bobo/krooms/mounatins/specialpath3e");
  return 1;
}
