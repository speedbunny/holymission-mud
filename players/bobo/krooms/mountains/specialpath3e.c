#define PR "players/bobo/krooms/mountains/specialpath3w"
...
se() {
   TP->MOVEP("southeast#players/bobo/krooms/mounatins/specialpath2e");
  return 1;
}

north() {
   TP->MOVEP("north#players/bobo/krooms/mounatins/path10");
  return 1;
}
