#define PR "players/bobo/krooms/mountains/specialpath1e"
...
south() {
   TP->MOVEP("south#players/bobo/krooms/mountains/rocks7");
  return 1;
}

ne() {
   TP->MOVEP("northeast#players/bobo/krooms/mountains/specialpath2w");
  return 1;
}
