...
reset(arg) {
  ...
  dest_dir=({
	"players/bobo/krooms/mountains/darkpath","north",
	"players/bobo/krooms/mountains/ante_den","south",
	"players/bobo/krooms/mountains/stonepath6","southeast",
	"players/bobo/krooms/mountains/stonepath5","southwest",
   });
   items=({
