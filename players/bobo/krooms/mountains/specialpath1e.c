#define PR "players/bobo/krooms/mountains/specialpath1w"
...
se() {
   TP->MOVEP("southeast#players/bobo/krooms/mountains/path7");
  return 1;
}

ne() {
   TP->MOVEP("northeast#players/bobo/krooms/mounatins/specialpath2e");
  return 1;
}
