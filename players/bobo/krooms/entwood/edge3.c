...
reset(arg) {
  ...
  dest_dir=({
	"players/bobo/krooms/entwood/edge4","north",
	"players/bobo/krooms/entwood/edge2","south",
	"players/bobo/krooms/mountains/plain5","east",
	"players/bobo/krooms/entwood/wood2","west",
   });
