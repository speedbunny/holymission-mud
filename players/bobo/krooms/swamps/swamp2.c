...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp6","north",
	"players/bobo/krooms/swamps/swamp9","south",
	"players/bobo/krooms/swamps/swamp4","east",
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/swamps/under_sw2");
  return 1;
}
