...
reset(arg) {
    ...
    long_desc="You're in a wet and dark cave under the magic swamps.\n"+
     "There's a gate into a dungeon to the east.\n";
    dest_dir=({
	"players/bobo/krooms/swamps/under_sw6","south",
	"players/bobo/krooms/castle/dungeon5","east",
	"players/bobo/krooms/swamps/under_sw10","west",
   });
