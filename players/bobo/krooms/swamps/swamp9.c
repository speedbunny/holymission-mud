...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp1","north",
	"players/bobo/krooms/swamps/swamp8","south",
	"players/bobo/krooms/swamps/swamp11","east",
	"players/bobo/krooms/swamps/swamp10","west",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/swamps/under_sw9");
  return 1;
}
