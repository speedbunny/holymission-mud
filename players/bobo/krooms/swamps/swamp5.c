...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp9","north",
	"players/bobo/krooms/swamps/swamp4","south",
	"players/bobo/krooms/swamps/swamp8","east",
	"players/bobo/krooms/swamps/swamp7","west",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/under_sw5");
  return 1;
}
