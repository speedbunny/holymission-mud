...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp8","north",
	"players/bobo/krooms/swamps/swamp11","south",
	"players/bobo/krooms/swamps/swamp2","east",
	"players/bobo/krooms/swamps/swamp1","west",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/swamps/under_sw4");
  return 1;
}
