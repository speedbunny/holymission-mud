...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp4","north",
	"players/bobo/krooms/swamps/swamp7","south",
	"players/bobo/krooms/swamps/swamp10","east",
	"players/bobo/krooms/swamps/swamp9","west",
   });
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/swamps/under_sw12");
  return 1;
}
