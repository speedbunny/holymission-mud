...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp13","north",
	"players/bobo/krooms/swamps/swamp6","south",
	"players/bobo/krooms/swamps/swamp9","east",
	"players/bobo/krooms/swamps/swamp12","west",
   });
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhere#players/bobo/krooms/swamps/under_sw11");
  return 1;
}
