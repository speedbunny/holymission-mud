...
reset(arg) {
    ...
    dest_dir=({
	"players/bobo/krooms/swamps/swamp12","north",
	"players/bobo/krooms/swamps/swamp3","south",
	"players/bobo/krooms/swamps/swamp7","east",
	"players/bobo/krooms/swamps/swamp6","west",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  write("The ground gets softer and you seem to drown in the mud.\n");
   TP->MOVEP("into nowhre#players/bobo/krooms/swmaps/under_sw8");
  return 1;
}
