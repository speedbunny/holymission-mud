...
if (arg) return;
set_light(1);
short_desc="The road to the coliseum.";
long_desc=
"You are wandering down the road to the coliseum to watch the great\n"+
...
dest_dir=({
        "/players/figleaf/smurf/path","east",
	"players/bobo/arena/road5.c","west",
});
items=({
