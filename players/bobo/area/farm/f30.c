...
void reset(int arg) {
   clone_list=({
	1, 1, "deer","/players/bobo/monsters/deer", 0,
   });
   if (arg) return;
   ::reset (arg);
   set_light(1);
   ...
   dest_dir=({
	"/players/bobo/area/farm/f23","north",
	"/players/bobo/area/farm/f31","east",
	"/players/bobo/area/for/f2","south",
	"/players/bobo/area/farm/f29","west",
   });
   items=({
