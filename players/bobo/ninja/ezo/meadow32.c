...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        ...
        "northeast, and northwest is the rock face of the volcano crater.\n"+
	"There is a 'really big hole' in the ground.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
   ...
   dest_dir=({
	PPATH + "meadow17","east",
	PPATH + "meadow1","southeast",
        PPATH + "meadow16", "south",
        PPATH + "meadow15", "southwest",
        PPATH + "meadow31", "west",
	PPATH + "snail_hole","down",
   });
}
