...
reset (arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        "The ground here is grassy and there are flowers here. To the east,\n" +
        "southeast, south and southwest is the rock-face of the volcano-crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
	...
	"rock face","You think that the rock face extends almost to eternity",
        ...
        "crater", "You're inside the crater. Just look and around to see more of it",
	"volcano crater","You're in the crater, just look about you to see more",
	"volcano","You're inside the crater, just look around you to see more",
   });
   smell = "You smell the odor of grass.";
   dest_dir=({
	PPATH + "meadow8","south",
        PPATH + "meadow7",  "northeast",
        PPATH + "meadow25", "west",
        PPATH + "meadow9",  "northwest",
   });
}
