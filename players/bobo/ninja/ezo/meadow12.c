...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        ...
        "east is the western wall of a house and to the southwest\n" +
        "is the rock face of the volcano crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
   ...
   dest_dir=({
	PPATH + "meadow13","north",
        PPATH + "meadow11", "south",
        PPATH + "meadow27", "west",
        PPATH + "meadow28", "northwest",
   });
}
