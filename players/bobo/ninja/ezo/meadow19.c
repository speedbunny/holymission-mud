...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meaadow in a hollow of the island of Ezo.\n"+
        "The ground here is grassy and there are flowers here. To the north,\n" +
        "notheast, east and northwest is the rock face of the volcano.\n"+
        "crater. If you look up you see the little stony plateau of the "+
        "'dragon airways'.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
        "ground", "The ground is grassy and you can see some flowers",
        "plateau","The stony plateau of the dragon airlines",
   ...
   dest_dir=({
	PPATH + "meadow20","southeast",
        PPATH + "meadow3",  "south",
        PPATH + "meadow2",  "southwest",
        PPATH + "meadow18","west",
        "/players/warlord/trans/port6","up",
   });
}
