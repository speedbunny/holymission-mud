...
reset(arg) {
   ...
   long_desc=
	...
	"north is the southern wall of a house and to the southeast\n"+
	"is the rock face of teh volcano crater.\n";
   items=({
	"meadow", long_desc,
	"hollow", long_desc,
	...
	"volcano crater","You're inside the crater, just look around to see it",
	"volcano","You're inside the crater, just look around to see more",
   });
   smell = "You smell the odor of grass.";
   dest_dir=({
	PPATH + "meadow7","east",
	PPATH + "meadow24","south",
	PPATH + "meadow25","southwest",
        PPATH + "meadow9","west",
   });
}
