...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze3/j25.c","north",
	"/players/bobo/clan/rooms/maze3/j26.c","east",
	"/players/bobo/clan/rooms/maze3/j25.c","south",
	"/players/bobo/clan/rooms/maze3/j24.c","west",
      });
   items=({
