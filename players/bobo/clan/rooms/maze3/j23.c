...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze4/j23.c","north",
	"/players/bobo/clan/rooms/maze3/j23.c","east",
	"/players/bobo/clan/rooms/maze3/j23.c","south",
	"/players/bobo/clan/rooms/maze3/j22.c","west",
      });
   items=({
