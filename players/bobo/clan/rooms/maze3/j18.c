...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze3/j19.c","north",
	"/players/bobo/clan/rooms/maze3/j18.c","east",
	"/players/bobo/clan/rooms/maze3/j17.c","south",
	"/players/bobo/clan/rooms/maze3/j18.c","west",
      });
   items=({
