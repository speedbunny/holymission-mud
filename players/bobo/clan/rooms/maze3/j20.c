...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze3/j20.c","north",
	"/players/bobo/clan/rooms/maze3/j21.c","east",
	"/players/bobo/clan/rooms/maze3/j19.c","south",
	"/players/bobo/clan/rooms/maze3/j20.c","west",
      });
   items=({
