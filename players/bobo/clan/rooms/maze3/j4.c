...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze3/j4.c","north",
	"/players/bobo/clan/rooms/maze3/j4.c","east",
	"/players/bobo/clan/rooms/maze3/j5.c","south",
	"/players/bobo/clan/rooms/maze3/j3.c","west",
      });
   items=({
