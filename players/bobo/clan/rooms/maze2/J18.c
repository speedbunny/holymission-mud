...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J18.c","north",
	"/players/bobo/clan/rooms/maze2/J18.c","east",
	"/players/bobo/clan/rooms/maze2/J17.c","south",
	"/players/bobo/clan/rooms/maze2/J19.c","west",
      });
   items=({
