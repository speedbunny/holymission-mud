...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J13.c","north",
	"/players/bobo/clan/rooms/maze2/J14.c","east",
	"/players/bobo/clan/rooms/maze2/J12.c","south",
	"/players/bobo/clan/tooms/maze2/J13.c","west",
      });
   items=({
