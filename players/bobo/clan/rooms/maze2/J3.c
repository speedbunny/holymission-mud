...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J3.c","north",
	"/players/bobo/clan/rooms/maze2/J4.c","east",
	"/players/bobo/clan/rooms/maze2/J2.c","south",
	"/players/bobo/clan/rooms/maze2/J3.c","west",
      });
   items=({
