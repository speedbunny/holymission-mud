...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J25.c","north",
	"/players/bobo/clan/rooms/maze2/J23.c","east",
	"/players/bobo/clan/rooms/maze2/J24.c","south",
	"/players/bobo/clan/rooms/maze2/J24.c","west",
      });
   items=({
