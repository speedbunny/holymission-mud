...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J4.c","north",
	"/players/bobo/clan/rooms/maze2/J6.c","east",
	"/players/bobo/clan/rooms/maze2/J5.c","south",
	"/players/bobo/clan/rooms/maze2/J5.c","west",
      });
   items=({
