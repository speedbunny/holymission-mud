...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J17.c","north",
	"/players/bobo/clan/rooms/maze2/J16.c","east",
	"/players/bobo/clan/rooms/maze2/J16.c","south",
	"/players/bobo/clan/rooms/maze2/J15.c","west",
      });
   items=({
