...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze2/J21.c","north",
	"/players/bobo/clan/rooms/maze2/J22.c","east",
	"/players/bobo/clan/rooms/maze2/J23.c","south",
	"/players/bobo/clan/rooms/maze2/J22.c","west",
      });
   items=({
