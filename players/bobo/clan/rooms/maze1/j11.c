...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j10.c","north",
	"/players/bobo/clan/rooms/maze1/j11.c","east",
	"/players/bobo/clan/rooms/maze1/j11.c","south",
	"/players/bobo/clan/rooms/maze1/j12.c","west",
      });
   items=({
