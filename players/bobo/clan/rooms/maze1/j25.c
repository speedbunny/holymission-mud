...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j26.c","north",
	"/players/bobo/clan/rooms/maze1/j24.c","east",
	"/players/bobo/clan/rooms/maze1/j25.c","south",
	"/players/bobo/clan/rooms/maze1/j25.c","west",
      });
   items=({
