...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j20.c","north",
	"/players/bobo/clan/rooms/maze1/j20.c","east",
	"/players/bobo/clan/rooms/maze1/j19.c","south",
	"/players/bobo/clan/rooms/maze1/j21.c","west",
      });
   items=({
