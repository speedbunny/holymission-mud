...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j6.c","north",
	"/players/bobo/clan/rooms/maze1/j5.c","east",
	"/players/bobo/clan/rooms/maze1/j4.c","south",
	"/players/bobo/clan/rooms/maze1/j5.c","west",
      });
   items=({
