...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j3.c","north",
	"/players/bobo/clan/rooms/maze1/j4.c","east",
	"/players/bobo/clan/rooms/maze1/j3.c","south",
	"/players/bobo/clan/rooms/maze1/j2.c","west",
      });
   items=({
