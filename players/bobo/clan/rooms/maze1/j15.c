...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j15.c","north",
	"/players/bobo/clan/rooms/maze1/j16.c","east",
	"/players/bobo/clan/rooms/maze1/j15.c","south",
	"/players/bobo/clan/rooms/maze1/j14.c","west",
      });
   items=({
