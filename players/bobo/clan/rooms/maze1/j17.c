...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j17.c","north",
	"/players/bobo/clan/rooms/maze1/j18.c","east",
	"/players/bobo/clan/rooms/maze1/j16.c","south",
	"/players/bobo/clan/rooms/maze1/j17.c","west",
      });
   items=({
