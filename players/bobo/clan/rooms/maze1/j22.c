...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j22.c","north",
	"/players/bobo/clan/rooms/maze1/j21.c","east",
	"/players/bobo/clan/rooms/maze1/j22.c","south",
	"/players/bobo/clan/rooms/maze1/j23.c","west",
      });
   items=({
