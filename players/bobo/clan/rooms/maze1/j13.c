...
reset (arg) {
   ...
   dest_dir=({
	"/players/bobo/clan/rooms/maze1/j14.c","north",
	"/players/bobo/clan/rooms/maze1/j13.c","east",
	"/players/bobo/clan/rooms/maze1/j12.c","south",
	"/players/bobo/clan/rooms/maze1/j13.c","west",
      });
   items=({
