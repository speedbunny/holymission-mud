...
string s;
     ...
     if(!arg) {
         set_light(1);
         short_desc="The Allport Branch of The Association Of The Money Brokers";
         long_desc=
    "You are standing inside the Allport branch of The Money Brokers.\n"
  ...
  + "    The Town Hall lies to the west.\n";
         dest_dir=({
             "players/topaz/rooms/cont/town_hall","north",
             "players/topaz/rooms/cont/main_street5","west",
                  });
         items=({
             "bank","@@short",
             "association","@@short",
