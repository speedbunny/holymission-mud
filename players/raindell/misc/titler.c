...
#include "/players/raindell/misc/titles"
...
reset(arg) {
  ...
  set_name("titler");
  set_alias("titler");
  set_short("Raindell's magic Titler");
  set_long("This titler gives Raindell random titles when he logs on");
}
...
query_auto_load() {
  return "players/raindell/misc/titler:";
}
