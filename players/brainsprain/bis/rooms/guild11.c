...
reset(arg) {
  short_desc = "Saferoom for members of the Barbarian's Guild";
   long_desc =
"Opulent tapestries cover the walls here.  Rugs that seem to have "+
"been spun from pure gold cover the floor.  Hanging over the "+
"gilded fireplace is the insignia of the Barbarian's guild.   You feel "+
"safe from members of all other guilds here.\n";
  ...
  dest_dir = ({
   ...
   items = ({
    ...
    "insignia","The insignia of the Barbarian's guild",
});
