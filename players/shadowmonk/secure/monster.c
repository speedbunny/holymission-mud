...
//---------------------------------------------------------------------------
private int handle_concentration(object victim) {
  if(funcall(call, TO, "concentrate", victim)) {
