...
#define WHEREFROM "players/sauron/sys/rwhere/wherefrom/wherefrom"
#define VERSION "1.0"
 ...
 *----------------------------------------------------------------*/
  ...
  switch (lv) {
  case L_APPR: return "App ";
  case L_NEWWIZ: return "New ";
  case L_WIZ: return "Wiz ";
  case L_SAGE: return "Sge ";
  case L_RETD: return "Ret ";
  case L_ELDER: return "Edr ";
  case L_ARCH: return "Arc ";
