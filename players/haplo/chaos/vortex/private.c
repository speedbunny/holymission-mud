...
{
  ::init();
write("QUEST CHEAT: LOGGED, TELEPORT TO FINAL ROOM. YOUR ANYSLAYER QUEST REMOVED.\n");
log_file("QUEST.CHEAT",this_player()->query_name()+"attempted to cheat on anyslayer quest on "+
ctime(time())+".\n");
