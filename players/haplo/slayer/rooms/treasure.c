...
int weapon_hit(object attacker) {
    if(attacker->query_race()=="orc") {
        write("The orc slayer glows in a blood red light.\n");
        return 10;
    }
    return 0;
}
...
void reset(int arg) {
  ...
  long_desc=
         "You are in the orc treasury. The treasure room is filled with "+
         "the skulls from the greatest enemies who have dare trespassed "+
         "here.  The ground is stained red from the blood that has been "+
         "spilled here.  To the south is the entrance to the fortress "+
         "of the orcs.\n";
  dest_dir=({
         ORC+"fortress", "south",
  });
  items=({
         "skulls", "Skulls of past enemies",
         "ground", "Stained red from blood",
         "here", "Here, right here, duh",
         "entrance", "The entrance to the orc fortress",
         "fortress", "The orc fortress",
         "blood", "Red blood",
         "red", "Red blood",
         "enemies", "The skulls of past enemies",
