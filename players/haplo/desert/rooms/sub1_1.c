...
corridor you are now in. There is a curved staircase leading up through a hole  \
in the ceiling.\n";

        dest_dir=({
      "/players/haplo/desert/rooms/pyramid1","up",
      "/players/haplo/desert/rooms/sub1_2","north"
        });
