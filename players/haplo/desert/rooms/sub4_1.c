...
corridor you are now in. There is a stone staircase leading up through a hole \
in the ceiling.\n";

        dest_dir=({
      "/players/haplo/desert/rooms/sub3_9","up",
      "/players/haplo/desert/rooms/sub4_2","north",
      "/players/haplo/desert/rooms/sub4_4","east"
        });
