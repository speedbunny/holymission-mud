...
from the desert",
        ...
        set_door          ( "wooden door" );
        set_door_desc     ( "wooden door", "an oaken wood door" );
        set_door_direction( "wooden door", "south" );
        set_lock_status   ( "wooden door", DOOR_LOCKED + 1 );
        set_invisible_doors( ({ "wooden door" }) );
        set_door_key      ( "wooden door", "jabba_1" );
        set_other_door    ( "wooden door" );
