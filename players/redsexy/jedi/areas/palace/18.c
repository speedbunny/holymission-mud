...
the corner leads down.  The red carpet here is still bloodsoaked from a recent \
...
the whole place stinks of death. \n\n";
        ...
        dest_dir = ({
            "/players/redsexy/jedi/areas/palace/17",  "east",
            "/players/redsexy/jedi/areas/palace/20",  "down",
        });
