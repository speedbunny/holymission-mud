...
void reset(int arg) {
  ...
  long_desc="The dining area of the upper sanctum is manned by the haphazard chef, Doofy. "+
            "Despite his chaoctic flailings around the kitchen, everything in here smells  "+
            "appetising and you long taste some of the Jedi delights he is cooking up "+
            "There is a menu here, perhaps you should read it?\n ";

  dest_dir=({"/players/mangla/guild/corridor2","east",
           });
