...
void reset(int arg){
 object board;
  ...
  long_desc =
    ...
    "sanctuary, whilst up above the chaos continues.\n ";
    ...
    dest_dir = ({"/players/mangla/guild/caperoom","east",
                 "/players/mangla/guild/room","up",
             });
...
init(){
 ...
 if(TP->query_guild()!= 4 && !TP->query_immortal()) {
    ...
    TP->MOVEP("is repelled by the power of the Force#players/redsexy/jedi/areas/guild/room");
    return;
  }
