...
void reset(int arg) {     
    if(!arg) {
        ...
        set_light(1);
        short_desc = "The Jedi Storage Room.";     
        long_desc = "\
...
the far wall. \n\n";
    ...
    smell="\nThe room smells freshly polished.\n";
        ...
        dest_dir = ({
            "/players/mangla/guild/darkroom",  "east",
            "/players/mangla/guild/lightroom", "west",
            "/players/mangla/guild/neutral", "south",
            "/players/mangla/guild/storage", "north",
...
_list(str) {
  set_store_room("/players/mangla/guild/store");
...
*/
  ...
  if (this_player()->query_real_guild()!=4) {
        ...
        this_player()->move_player("is moved#players/redsexy/jedi/areas/guild/room");
        return 1 ;
  }
