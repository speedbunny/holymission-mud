...
void reset(int arg) {
  ...
  long_desc="The redbrick path that runs around the square is a little cracked here "+
            ...
            "the south is a stone hut with a sign outside labelled 'Ambrose's Creamery'.\n\n  ";

  dest_dir=({"/players/redsexy/jedi/areas/moseisley/19","southwest",
             "/players/redsexy/jedi/areas/moseisley/20","south",
           });
