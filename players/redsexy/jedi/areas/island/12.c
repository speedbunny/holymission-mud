...
dest_dir=({              "/players/redsexy/jedi/areas/island/40.c", "west",              
                         "/players/redsexy/jedi/areas/island/13.c", "southwest",    
                         "/players/redsexy/jedi/areas/island/11.c", "northeast",     });
...
int _search(string str) {
   ...
   write("You barely scratch the surface of the sand, it is so hot! \n");
   return 1;
