...
long_desc="You are now walking across the vast plains of sand that spread " +
              ...
              "Just sand, everywhere, and two evil hot suns glaring down evilly " +
...
dest_dir=({              "/players/redsexy/jedi/areas/island/28.c", "south",
                         "/players/redsexy/jedi/areas/island/26.c", "north",
                         "/players/redsexy/jedi/areas/island/29.c", "east",     });
...
items = ({    "view","Sand spreads out in front of you, behind you, everywhere.",            
              ...
              "suns", "Two evil hot suns, burning your skin as they glare upon you.",
              "sun","Two evil hot suns, burning your skin as they glare upon you.",
...
int _search(string str) {
   ...
   write("You look around as hard as you can, but cannot see anything of worth. \n");
   return 1;
