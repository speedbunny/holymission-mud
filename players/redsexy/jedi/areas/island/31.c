...
long_desc="You are now walking across the vast plains of sand that spread\n" + 
    ...
    dest_dir=({               "/players/redsexy/jedi/areas/island/32.c", "south",
                              "/players/redsexy/jedi/areas/island/30.c", "northeast",     });
...
int _search(string str) {
   ...
   write("You burrow deep in the sand, but find nothing. \n");
   return 1;
