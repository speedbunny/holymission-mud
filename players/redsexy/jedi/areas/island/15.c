...
dest_dir=({              "/players/redsexy/jedi/areas/island/32.c", "west", 
                         "/players/redsexy/jedi/areas/island/16.c", "southwest",          
                         "/players/redsexy/jedi/areas/island/14.c", "northeast",     });
...
int _search(string str) {
   ...
   write("You search and search but there is nothing in this area. \n");
   return 1;
