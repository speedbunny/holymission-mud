...
dest_dir=({              "/players/redsexy/jedi/areas/island/39.c", "west",
                         "/players/redsexy/jedi/areas/island/14.c", "southwest",              
                         "/players/redsexy/jedi/areas/island/12.c", "northeast",     });
...
int _search(string str) {
   ...
   write("You search and search but you don't even find one coin! \n");
   return 1;
