...
dest_dir=({              "/players/redsexy/jedi/areas/island/32.c", "north",       
                         "/players/redsexy/jedi/areas/island/17.c", "southwest",              
                         "/players/redsexy/jedi/areas/island/15.c", "northeast",     });
...
int _search(string str) {
   ...
   write("You find nothing hidden here  \n");
   return 1;
