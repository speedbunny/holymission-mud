...
long_desc="You are now walking across the vast plains of sand " + 
              ...
              "and two evil hot suns glaring down evilly from " + 
...
dest_dir=({               "/players/redsexy/jedi/areas/island/30.c", "west",               
                          "/players/redsexy/jedi/areas/island/40.c", "northeast",
                          "/players/redsexy/jedi/areas/island/13.c", "east",     });
...
int _search(string str) {
   ...
   write("Despite searching long and hard you uncover nothing of worth. \n");
   return 1;
