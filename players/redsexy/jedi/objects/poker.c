   ...
   /* coded by Matt Robinson 1991 
       ...
       by Haplo 12-24-95  
       modified to work on gambling chips as a poker table
       by Redsexy 29-11-97*/

#include "/players/haplo/casino/pokerdefs.h"
#define TP this_player()
#define qch ob->query_credits()
...
id(str)
{
    return str == "table" || str == "poker table";
}

short()
{
    return "A poker table";
}

long()
{
    write("This is a poker table, where anyone with credits can try\n");
    write("their luck.  Corellian gamblers crowd around waiting to \n");
    write("play but if you are not as expert as these hustlers type \n");
    write("in 'help poker'.  When you are ready, type 'play poker'.\n");
    write("and the Whipid will deal you a hand.\n");
...
help2(str)
{
    ...
    */
    ...
    write("Modified by Haplo (C)1995........and.........Redsexy (C)1997. \n");
    return 1;
}
...
clean_player()
{
    ...
    say(p + " takes too long and the Whipid takes back the cards!\n");
...
{   
    ...
    */
    ...
    {
        ob->add_credits(-500);
        write("Sorry, you lost!! You now have "+ob->query_credits()+" credits!\n");
        say(capitalize(playerob->query_name()) +
               " loses 500 credits on the poker table!\n");
    }
    else
    {
        write(" The Whipid reluctantly gives you " + (10 * num) + " credits.\n");
        ob->add_credits(10 * num);
        say(capitalize(playerob->query_name()) +
                " wins " + (10 * num) + " credits from the poker machine!\n");
     }
    return 1;
}
        ...
        else
        {
            ...
            */
            if (ident == 2)
            {
                ...
                {
                    write("You have nothing in your hand.  The Whipid ");
                    write("chuckles to herself.\n(You must have Jacks or ");
            ...
            */
            ...
            {
                write("You have nothing in your hand.  The Whipid ");
                write("laughs as she takes your credits.\n");
                payoff(NOTHING);
            }
        }
    }
    ...
    */
    while (loop >= 0)
    {
        ...
        */
        ...
        {
            write("The Whipid didn't understand your language so took the cards back.\n");
            exit_out();
            return 1;
        }
        /*
        ...
        */
        ...
        {
            write("The Whipid doesn't understand what you are trying to do, so just takes the cards back.\n");
            exit_out();
            return 1;
        }
        /*
...
{  
  ...
  if(500>has)
    {write("You have to have 500 credits to play at this table!\n");
        return 1;
    }
    ...
    say(capitalize(playerob->query_name())
                   + " plays a game of poker on the table.\n");
     this_player()->add_credits(-500);
    write("You give the Whipid 500 credits to play poker.\n");
    ...
    */
    ...
    {
        write("The Whipid reshuffles the deck.\n");
    ...
    */
    write("The Whipid deals you some cards:\n\n"); deal(); write("\n");
