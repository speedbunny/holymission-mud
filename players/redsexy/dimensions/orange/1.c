...
void reset(int arg) {     
  ...
  long_desc="\
You stand in the highest orange dimension chamber, where the keeper \
of the orange demons lives.  The whole room is made of glass, reflecting \
...
the man who stands before you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/3","west",
             "/players/redsexy/dimensions/orange/2","east",
          });
  ...
  items=({"halls","The dimension halls of Sophillicus",
          ...
          "walls","The walls are made of mirroorange glass",
          "light","A mystical light is reflected off the mirrors",
          "glass","Glass from which the chamber are built",
          "man","The keeper of the orange Domain",
         });
   clone_list=({

          1, 1, "keeper", "/players/redsexy/dimensions/monsters/orangekeeper", 0,
