...
no meaning.  You stand in the outer chambers of the orange demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({ "/players/redsexy/dimensions/orange/14","west",
              "/players/redsexy/dimensions/orange/10","northwest",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/orange15", 0,
