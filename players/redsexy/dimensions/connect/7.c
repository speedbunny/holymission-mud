...
illuminating the glass walls that surround you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/chamber","east",
             "/players/redsexy/dimensions/indigo/1","west",
          });
...
int _put(string str) {
object indigococoon, indigochute;


  switch(str) {
    case "indigo cocoon in chute" :
    case "indigo cocoon down chute" :
    case "indigo coccon into the chute" :
    case "indigo cocoon into chute" :
    case "indigo cocoon down the chute" :
    case "indigo coccon in the chute":
    indigococoon = present("indigo cocoon", TP);
    if(indigococoon) {
        write("You put the indigo cocoon into the chute.\n");
        say(TPN + " puts the indigo cocoon in the chute.\n");
        indigochute = clone_object("players/redsexy/dimensions/quest/chute");
        transfer(indigochute, this_player());
        indigochute->set_type("indigo");
