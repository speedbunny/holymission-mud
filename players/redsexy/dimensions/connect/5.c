...
illuminating the glass walls that surround you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/chamber","north",
             "/players/redsexy/dimensions/green/1","south",
          });
...
int _put(string str) {
object greencocoon, greenchute;


  switch(str) {
    case "green cocoon in chute" :
    case "green cocoon down chute" :
    case "green coccon into the chute" :
    case "green cocoon into chute" :
    case "green cocoon down the chute" :
    case "green coccon in the chute":
    greencocoon = present("green cocoon", TP);
    if(greencocoon) {
        write("You put the green cocoon into the chute.\n");
        say(TPN + " puts the green cocoon in the chute.\n");
        greenchute = clone_object("players/redsexy/dimensions/quest/chute");
        transfer(greenchute, this_player());
        greenchute->set_type("green");
