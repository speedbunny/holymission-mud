...
illuminating the glass walls that surround you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/chamber","southeast",
             "/players/redsexy/dimensions/violet/1","northwest",
          });
...
int _put(string str) {
object violetcocoon, violetchute;


  switch(str) {
    case "violet cocoon in chute" :
    case "violet cocoon down chute" :
    case "violet coccon into the chute" :
    case "violet cocoon into chute" :
    case "violet cocoon down the chute" :
    case "violet coccon in the chute":
    violetcocoon = present("violet cocoon", TP);
    if(violetcocoon) {
        write("You put the violet cocoon into the chute.\n");
        say(TPN + " puts the violet cocoon in the chute.\n");
        violetchute = clone_object("players/redsexy/dimensions/quest/chute");
        transfer(violetchute, this_player());
        violetchute->set_type("violet");
