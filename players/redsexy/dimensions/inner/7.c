...
this way for a while. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/inner/chamber","east",
          });
...
if(present("indigochute", this_player())) {
   object indigochute;
   indigochute=present("indigochute", this_player());
   write("You feel you are really helping Sophillicus.\n");
   destruct(indigochute);
   move_object(clone_object("/players/redsexy/dimensions/quest/indigococoon"), this_object());
  }  
}
