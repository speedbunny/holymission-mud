...
this way for a while. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/inner/chamber","northwest",
          });
...
if(present("yellowchute", this_player())) {
   object yellowchute;
   yellowchute=present("yellowchute", this_player());
   write("You feel you are really helping Sophillicus.\n");
   destruct(yellowchute);
   move_object(clone_object("/players/redsexy/dimensions/quest/yellowcocoon"), this_object());
  }  
}
