...
this way for a while. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/inner/chamber","west",
          });
...
if(present("orangechute", this_player())) {
   object orangechute;
   orangechute=present("orangechute", this_player());
   write("You feel you are really helping Sophillicus.\n");
   destruct(orangechute);
   move_object(clone_object("/players/redsexy/dimensions/quest/orangecocoon"), this_object());
  }  
}
