...
this way for a while. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/inner/chamber","northeast",
          });
...
if(present("bluechute", this_player())) {
   object bluechute;
   bluechute=present("bluechute", this_player());
   write("You feel you are really helping Sophillicus.\n");
   destruct(bluechute);
   move_object(clone_object("/players/redsexy/dimensions/quest/bluecocoon"), this_object());
  }  
}
