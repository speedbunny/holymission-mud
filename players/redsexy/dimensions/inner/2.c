...
this way for a while. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/inner/chamber","southwest",
          });
...
if(present("redchute", this_player())) {
   object redchute;
   redchute=present("redchute", this_player());
   write("You feel you are really helping Sophillicus.\n");
   destruct(redchute);
   move_object(clone_object("/players/redsexy/dimensions/quest/redcocoon"), this_object());
  }  
}
