...
void reset(int arg) {     
  ...
  long_desc="\
You stand in the highest yellow dimension chamber, where the keeper \
of the yellow demons lives.  The whole room is made of glass, reflecting \
...
the man who stands before you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/4","northwest",
             "/players/redsexy/dimensions/yellow/2","east",
          });
  ...
  items=({"halls","The dimension halls of Sophillicus",
          ...
          "walls","The walls are made of mirroyellow glass",
          "light","A mystical light is reflected off the mirrors",
          "glass","Glass from which the chamber are built",
          "man","The keeper of the yellow Domain",
         });
   clone_list=({

          1, 1, "keeper", "/players/redsexy/dimensions/monsters/yellowkeeper", 0,
