...
no meaning.  You stand in the outer chambers of the yellow demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({ "/players/redsexy/dimensions/yellow/13","east",
              "/players/redsexy/dimensions/yellow/11","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/yellow12", 0,
          2, 1, "yellow cocoon", "/players/redsexy/dimensions/quest/yellowcocoon", 0,
