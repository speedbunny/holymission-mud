...
no meaning.  You stand in the lower chambers of the yellow demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/yellow/15","southeast",
             "/players/redsexy/dimensions/yellow/9","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/yellow10", 0,
