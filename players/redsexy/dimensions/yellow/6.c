...
no meaning.  You stand in the middle chambers of the yellow demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/yellow/3","northwest",
             "/players/redsexy/dimensions/yellow/5","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/yellow6", 0,
