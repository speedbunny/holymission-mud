...
int _switch(string str) {
  ...
  if(incubator) {
    redcocoon = present("redquestob", incubator);
    orangecocoon = present("orangequestob", incubator);
    yellowcocoon = present("yellowquestob", incubator);
    greencocoon = present("greenquestob", incubator);
    bluecocoon = present("bluequestob", incubator);
    indigococoon = present("indigoquestob", incubator);
    violetcocoon = present("violetquestob", incubator);
  }
