...
no meaning.  You stand in the outer chambers of the red demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({ "/players/redsexy/dimensions/red/14","west",
              "/players/redsexy/dimensions/red/10","northwest",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/red15", 0,
          2, 1, "red cocoon", "/players/redsexy/dimensions/quest/redcocoon", 0,
