...
no meaning.  You stand in the higher chambers of the red demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/red/2","west",
             "/players/redsexy/dimensions/red/6","southeast",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/red3", 0,
