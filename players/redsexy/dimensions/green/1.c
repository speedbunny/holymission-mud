...
void reset(int arg) {     
  ...
  long_desc="\
You stand in the highest green dimension chamber, where the keeper \
of the green demons lives.  The whole room is made of glass, reflecting \
...
the man who stands before you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/5","north",
             "/players/redsexy/dimensions/green/2","south",
          });
  ...
  items=({"halls","The dimension halls of Sophillicus",
          ...
          "walls","The walls are made of mirrogreen glass",
          "light","A mystical light is reflected off the mirrors",
          "glass","Glass from which the chamber are built",
          "man","The keeper of the green Domain",
         });
   clone_list=({

          1, 1, "keeper", "/players/redsexy/dimensions/monsters/greenkeeper", 0,
