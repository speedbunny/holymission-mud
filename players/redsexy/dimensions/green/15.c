...
no meaning.  You stand in the outer chambers of the green demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({ "/players/redsexy/dimensions/green/14","west",
              "/players/redsexy/dimensions/green/10","northwest",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/green15", 0,
