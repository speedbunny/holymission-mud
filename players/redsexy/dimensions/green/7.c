...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/green/4","northeast",
             "/players/redsexy/dimensions/green/8","east",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/green7", 0,
          2, 1, "green cocoon", "/players/redsexy/dimensions/quest/greencocoon", 0,
