...
no meaning.  You stand in the outer chambers of the indigo demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({ "/players/redsexy/dimensions/indigo/14","east",
              "/players/redsexy/dimensions/indigo/12","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/indigo13", 0,
          2, 1, "indigo cocoon", "/players/redsexy/dimensions/quest/indigococoon", 0,
