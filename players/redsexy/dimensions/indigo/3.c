...
no meaning.  You stand in the higher chambers of the indigo demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/indigo/2","west",
             "/players/redsexy/dimensions/indigo/6","southeast",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/indigo3", 0,
