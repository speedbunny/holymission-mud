...
no meaning.  You stand in the lower chambers of the indigo demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/indigo/15","southeast",
             "/players/redsexy/dimensions/indigo/9","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/indigo10", 0,
