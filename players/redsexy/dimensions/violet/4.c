...
no meaning.  You stand in the middle chambers of the violet demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/violet/5","east",
             "/players/redsexy/dimensions/violet/7","southwest",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/violet4", 0,
