...
void reset(int arg) {     
  ...
  long_desc="\
You stand in the highest violet dimension chamber, where the keeper \
of the violet demons lives.  The whole room is made of glass, reflecting \
...
the man who stands before you. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/connect/8","southeast",
             "/players/redsexy/dimensions/violet/2","northwest",
          });
  ...
  items=({"halls","The dimension halls of Sophillicus",
          ...
          "walls","The walls are made of mirroviolet glass",
          "light","A mystical light is reflected off the mirrors",
          "glass","Glass from which the chamber are built",
          "man","The keeper of the violet Domain",
         });
   clone_list=({

          1, 1, "keeper", "/players/redsexy/dimensions/monsters/violetkeeper", 0,
