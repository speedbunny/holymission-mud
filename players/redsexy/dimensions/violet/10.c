...
no meaning.  You stand in the lower chambers of the violet demons, \
...
the ear.  You feel calm yet alert as you venture onwards. \n\n";
  ...
  dest_dir=({"/players/redsexy/dimensions/violet/15","southeast",
             "/players/redsexy/dimensions/violet/9","west",
           });
  ...
  items=({"halls","The dimension halls of Sophillicus",
   ...
   clone_list=({
          ...
          1, 1, "demon", "/players/redsexy/dimensions/monsters/violet10", 0,
          2, 1, "violet cocoon", "/players/redsexy/dimensions/quest/violetcocoon", 0,
