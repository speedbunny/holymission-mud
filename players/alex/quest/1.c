...
reset(arg) {
    ...
    "that your feet make sparks when they touch the floor.  You get the \n"+
    ...
    items=({
      ...
      "sparks",
      "The sparks are seen whever any part of your body comes in contact with the surroundings",
