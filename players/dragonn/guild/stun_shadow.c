...
{
   who->lock_input( time, "You are STUNNED.\n" );
...
end_shadow( o )
{
   tell_object( me, "With a scream you recover from STUN.\n" );
   say( apply(call,me,"query_name")+"screams and recovers of the STUN.\n" );
   me->unlock_input( );
...
{
   tell_object( me, "You cannot move, you are stunned.\n" );
