...
reset(arg) {
    ...
    if(!arg) {
       ...
       "This is a pretty workroom.It contains a laboratory.\n"+
   "If you look around you noticed that the owner is a kind\n"+
   "person.There are lots of shelves full with books.\n"+
     "There you can see a picture which draws by Szabolcs.\n"+
     "In the corner there are statue of a Dragon.\n"+
   "Welcome my folk!\n";

        /* we need some exits too ... lets set the destination directions */
        dest_dir=({
            "room/post", "post",
    "players/szabolcs/testroom","north",
    "room/newbroker","bank",
	    "room/church", "church",
            "room/adv_guild", "guild", 
 "players/patience/ezo/conference","san",
                 });
