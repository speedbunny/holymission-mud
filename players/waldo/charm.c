#include "/players/waldo/safdefs.h"
inherit "obj/treasure";

reset(arg) {
    if(arg) return;
    set_id("Saffrin's Love Charm (addition code by Waldo)");
    set_alias("charm");
    set_weight(1);
    set_value(8);
...
cwrap(str)
{
    ...
    TELL(victim,CAP(TPRN) +" wraps their arms around you.\n");
    return 1;
}
cclose(str)
{
...
clove(str)
{
    ...
    TELL(victim,CAP(TPRN) +" looks at you with love in their eyes.\n");
    return 1;
}
cgasp(str)
{
...
clive(str)
{
    ...
    TELL(victim,CAP(TPRN) +" tells you that they cannot live without you.\n");
    return 1;
}
csing(str)
{
...
_helpcharm()
{
    ...
    write("\n");
    write("If you have any suggestions, mail them to Saffrin or Waldo.\n");
    return 1;
}
