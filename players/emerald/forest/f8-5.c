...
void reset(int arg) {
  ...
  long_desc="You are in a deep forest.  Dark gnarled trees loom all around " +
            ...
            "animal tracks lead off in various directions.  A small bare hut "+
            "nestles between the trees to the north.\n";

  dest_dir=({"/players/emerald/forest/hermit_hut","north",
             "/players/emerald/forest/f8-4","east",
             "/players/emerald/forest/f8-6","west",
           });


  items=({"tree", "Any particular tree?",
          "hut","A small bare hut nestled in the woods",
