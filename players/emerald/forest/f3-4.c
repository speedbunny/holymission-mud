...
void reset(int arg) {
  ...
  dest_dir=({"/players/emerald/forest/f4-4","north",
             "/players/emerald/forest/f2-4","south",
             "/players/emerald/forest/f3-3","east",
             "/players/emerald/forest/f3-5","west",
             "/players/emerald/forest/f2-3","southeast",
           });
