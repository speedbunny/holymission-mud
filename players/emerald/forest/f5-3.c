...
void reset(int arg) {
  ...
  dest_dir=({"/players/emerald/forest/f6-3","north",
             "/players/emerald/forest/f5-2","east",
             "/players/emerald/forest/f6-4","northwest",
             "/players/emerald/forest/f4-2","southeast",
             "/players/emerald/forest/f4-4","southwest",
           });
