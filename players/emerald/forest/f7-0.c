...
void reset(int arg) {
  ...
  long_desc="You are in a deep forest.  Dark gnarled trees loom all around " +
            ...
            "animal tracks lead off in various directions.  A huge, tall " +
            "black tower rises up above you to the east.\n";

  dest_dir=({"/players/emerald/forest/tower_entry","east",
             "/players/emerald/forest/f7-1","west",
           });
  ...
  items=({"tree", "Any particular tree?",
          ...
          "towers","It's a huge, tall, black, sinister building",
