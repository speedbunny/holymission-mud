...
void reset(int arg) {
  ...
  dest_dir=({"/players/emerald/lakmir/shore4","north",
             "/players/emerald/lakmir/ocean3","east",
             "/players/emerald/lakmir/shore2","south",
             "/players/emerald/lakmir/bifurcation","west"
           });
