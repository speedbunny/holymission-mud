...
a=0;
  ...
  dest_dir=({"/players/emerald/lakmir/forest10","north",
             "/players/emerald/lakmir/clearing","east",
             "/players/emerald/lakmir/forest8","south",
             "/players/emerald/lakmir/valley","west",
           });
