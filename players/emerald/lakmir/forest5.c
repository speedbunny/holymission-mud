...
a=0;
  ...
  dest_dir=({"/players/emerald/lakmir/clearing","north",
             "/players/emerald/lakmir/forest2","east",
             "/players/emerald/lakmir/forest4","south",
             "/players/emerald/lakmir/forest8","west",
           });
