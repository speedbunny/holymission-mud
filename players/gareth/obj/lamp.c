...
rub(str) {
    ...
    return 1;
		...
		write_file("/players/gareth/obj/summon.log",
			 ...
			 ctime(time()) + "\n");
              ...
              "A djinni solidifies from a blue vapor.\n");
                ...
                call_other(djinni, "set_wc", 100);
                call_other(djinni, "set_ac", 65);
                call_other(djinni, "set_dex", 100);
                call_other(djinni, "set_level", 50);
