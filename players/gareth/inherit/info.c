...
reset() {
    ...
    set_id( "badge" );
    set_short( "A Red Badge of Courage" );
    set_long( "This is a dark, read badge of courage. \n" +
...
init() {
    ...
    AA( "cmd", "cmds" );
        ...
        if( TP->RNAME != "gareth" ) {
          write("This is a private tool that yor're not supposed to have!!\n"+
               "Enjoy re-logging in! I hope you've learned yer lesson Punk!\n");
           destruct( TO );
        }
...
query_auto_load() {
    return "/players/gareth/inherit/info:";
}
