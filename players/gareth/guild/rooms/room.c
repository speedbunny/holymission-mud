...
#include "/players/gareth/guild/rooms/guild.pic"
#define MAXLVL          30
...
void reset( int arg ) {
  if( arg ) return 0;
	 ...
	 long_desc = BS("You are standing in the inner halls of the great,"+
         ...
         dest_dir = ({  
             "/players/gareth/guild/rooms/castle","out",
             "/players/gareth/guild/rooms/restroom","south",
  ...
  if( !will ) {
        MO(CO("/players/gareth/guild/mon/will"), TO);
  }
}
