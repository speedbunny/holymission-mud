...
#define ROOM "/players/gareth/guild/rooms/"
#define TPOBJ  TP->query_objective()
#define TPPOS  TP->query_possessive()
#define STORE ("/players/gareth/guild/store/guild_store")
...
reset( arg ) {
    ...
    if ( !trader ) {
	trader = CO("/players/gareth/guild/mon/xena" );
	if ( trader )
	    TR( trader, TO );
    ...
    TR(CO( "/players/gareth/guild/store/can.c" ), TO);
