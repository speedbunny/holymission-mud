...
dest_dir = ({ "players/akira/area/ryu5", "south",
              "players/akira/area/ryu9", "east",
              "players/akira/area/ryu7", "west",
              "players/akira/area/ryu4", "southwest",
              "players/akira/area/ryu6", "southeast" });
}
