...
dest_dir = ({ "players/akira/area/ryu9", "north",
              "players/akira/area/ryu3", "south",
              "players/akira/area/ryu5", "west",
              "players/akira/area/ryu8", "northwest",
              "players/akira/area/ryu2", "southwest" });
}
