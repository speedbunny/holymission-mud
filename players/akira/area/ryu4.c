...
dest_dir = ({ "players/akira/area/ryu7", "north",
              "players/akira/area/ryu1", "south",
              "players/akira/area/ryu5", "east",
              "players/akira/area/ryu8", "northeast",
              "players/akira/area/ryu2", "southeast" });
}
