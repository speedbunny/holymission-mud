...
dest_dir = ({ "players/akira/area/ryu5", "north",
              "players/akira/area/ryu3", "east",
              "players/akira/area/ryu1", "west",
              "players/akira/area/ryu6", "northeast",
              "players/akira/area/ryu4", "northwest" });
}
