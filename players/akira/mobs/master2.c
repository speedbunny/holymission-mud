...
reset(arg){
	...
	set_ac(6);
        load_chat(10,({
                        "Master says: Today we learn Mindbolt.\n",
                        "The Master shoots a Mindbolt at the wall.\n",
                        "The Master says: A normal mind is easy to control.\n",
                        "The Master says: Mind Bleeding is an art!\n" }));
	}
hit_player(dam){
	switch(RAN(100)){
			case 0..20:
