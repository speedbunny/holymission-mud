...
{ ::reset(arg);
  ...
  { set_light(1);
    ...
    dest_dir =({"/players/beardy/walhalla/room/entrance","south",
                "/players/beardy/walhalla/room/floor2","north",
                "/players/beardy/walhalla/room/floor7","east",
                "/players/beardy/walhalla/room/entrance2","southeast",
                "/players/beardy/walhalla/room/floor6","northeast"});
