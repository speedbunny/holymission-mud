...
{ ::reset(arg);
  ...
  { set_light(1);
    ...
    dest_dir =({"/players/beardy/walhalla/room/floor1","west",
                "/players/beardy/walhalla/room/floor6","north",
                "/players/beardy/walhalla/room/floor2","northeast",
                "/players/beardy/walhalla/room/entrance2","south",
                "/players/beardy/walhalla/room/entrance","southwest"});
