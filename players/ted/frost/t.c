...
if(str == "metal" || str == "adamite" || str == "lump"
 ...
 if((!gotten) && set_light(0) <= 0) {
   ...
   if(!call_other(this_player(),"add_weight", 6)) {
	...
	move_object(adamite, this_player());
	gotten = 1;
	return 1;
   }
  if(gotten) {
