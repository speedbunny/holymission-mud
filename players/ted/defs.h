#define PATH      "/players/ted/"
#define ROOM       PATH + "room/"
#define OBJS       PATH + "obj/"
#define MNST       PATH + "monsters/"
#define WEAP       PATH + "weapons/"
#define HOT        PATH + "hot/"
#define FROST      PATH + "frost/"
#define PLAINS     PATH + "plains/"
#define COLD       PATH + "cold/"
#define FIRE       PATH + "fire/"
#define FOREST     PATH + "forest/"
#define KPATH      PATH + "path/"
#define QUEST1     PATH + "quest1/"
