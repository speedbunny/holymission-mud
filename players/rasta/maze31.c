...
e0() {
	...
	call_other(this_player(), "move_player", 
	 "north#players/rasta/room/maze41");
    else
	call_other(this_player(), "move_player", 
...
e1() {
    if (!exit_num)
	call_other(this_player(), "move_player", 
	  "south#players/rasta/room/maze41");
    else
	call_other(this_player(), "move_player", 
	  "south#players/rasta/room/maze11");
    return 1;
}
...
e2() {
	...
	call_other(this_player(), "move_player", 
	    "east#players/rasta/room/maze41");
    return 1;
}
...
e3() {
    if (!exit_num)
	call_other(this_player(), "move_player", 
	  "west#players/rasta/room/maze41");
    else
	call_other(this_player(), "move_player", 
