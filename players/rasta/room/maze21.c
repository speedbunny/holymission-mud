...
status exit3(){
	...
	this_player()->move_player("east#players/rasta/room/maze11");
    return 1;
}

status exit4(){
    if(!random(3))
	this_player()->move_player("west#players/rasta/room/maze11");
    else
	this_player()->move_player("west#players/rasta/room/maze31");
    return 1;
}
