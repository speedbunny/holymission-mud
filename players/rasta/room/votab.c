...
add_subject("Best Realm",
	"Which realm did you like the best? Most challenging, most enjoyable,\n"+
	"funny etc. All realms listed with 'realms' command are possible votes.\n"+
        "votes.realms");
...
write("List of current voting topics. You are welcome to give your vote!\n"+
      "=================================================================\n");
i = 0;
while (i < subject_nr)
	{
...
if (sscanf(todays_voters[sn], "%s#" + this_player()->query_name() + "#%s",
	...
	write("You feel like you are a much better citizen now!\n");
	}
}
