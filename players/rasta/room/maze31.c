...
status e0(){
    if(!random(3))
	this_player()->move_player("north#players/rasta/room/maze41");
    else
...
status e1(){
    if(!random(3))
	this_player()->move_player("south#players/rasta/room/maze41");
    else
...
status e2(){
	...
	this_player()->move_player("east#players/rasta/room/maze41");
    return 1;
}
