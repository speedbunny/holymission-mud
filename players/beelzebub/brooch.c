...
#include "/players/matt/guild/arrays.h"
...
#include "/players/matt/guild/spells/broochspells"
...
init() {
  ::init();
  if(TP->query_guild() != GUILD_NUM) destroy_me();
...
guild_list(obj1, obj2) {
  return (obj1->query_guild() == GUILD_NUM) &&
...
query_auto_load() {
  ...
  return "players/matt/guild/objects/brooch:" +
