...
long() { 
  write("This ring bears the symbol of Rahn.\n");
}
...
id(str) { return str== "ring" || str=="titanium ring" || str=="trlock2"; }

  destring() {
    write("The titanium ring suddenly disappears in a puff of smoke.\n");
