...
long() { 
  write("This ring bears the symbol of Yragore.\n");
}
...
id(str) { return str== "ring" || str=="emerald ring" || str=="trlock6"; }

  destring() {
    write("The emerald ring suddenly disappears in a puff of smoke.\n");
