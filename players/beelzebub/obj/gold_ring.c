...
long() { 
  write("This ring bears the symbol of Jark.\n");
}
...
id(str) { return str== "ring" || str=="gold ring" || str=="trlock3"; }

  destring() {
    write("The gold ring suddenly disappears in a puff of smoke.\n");
