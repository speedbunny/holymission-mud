...
long() { 
  write("This ring bears the symbol of Vissuluth, The Demon Lord.\n");
}
...
id(str) { return str== "ring" || str=="diamond ring" || str=="trlock8"; }

  destring() {
    write("The diamond ring suddenly disappears in a puff of smoke.\n");
