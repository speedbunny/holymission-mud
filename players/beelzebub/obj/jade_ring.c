...
long() { 
  write("This ring bears the symbol of Nyphur.\n");
}
...
id(str) { return str== "ring" || str=="jade ring" || str=="trlock1"; }

  destring() {
    write("The jade ring suddenly disappears in a puff of smoke.\n");
