...
long() { 
  write("This ring bears the symbol of Prish.\n");
}
...
id(str) { return str== "ring" || str=="ruby ring" || str=="trlock7"; }

  destring() {
    write("The ruby ring suddenly disappears in a puff of smoke.\n");
