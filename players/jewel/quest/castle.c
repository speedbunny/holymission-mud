#define NAME "jewel/quest"
#define DEST "/players/jewel/quest/workroom.c"
/*
...
init() {
    ...
    if(this_player()->query_real_name()=="jewel/quest") call_out("start_beep",1);
}

start_beep() {
if(present("jewel/quest",this_object())) {
