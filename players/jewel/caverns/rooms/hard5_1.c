...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for hard5_1";
       no_castle_flag = 0;
       long_desc = "blah blah blah. hard5_1.c\n";
       dest_dir = 
           ({"players/jewel/room/hard5_2", "north",
             "players/jewel/room/hard4_1", "east",
             "players/jewel/room/hard5", "south",
             "players/jewel/room/hard6_1", "west" 
           });
    }
    i = 0;
