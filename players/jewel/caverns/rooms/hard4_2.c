...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for hard4_2";
       no_castle_flag = 0;
       long_desc = "blah blah blah. hard4_2.c\n";
       dest_dir = 
           ({"players/jewel/room/hard4_3", "north",
            "players/jewel/room/hard3_2", "east",
            "players/jewel/room/hard4_1", "south",
            "players/jewel/room/hard5_2", "west" 
           });
    }
    i = 0;
