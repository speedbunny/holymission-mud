...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for hard3_1";
       no_castle_flag = 0;
       long_desc = "blah blah blah. hard3_1.c\n";
       dest_dir = 
           ({"players/jewel/room/hard3_2", "north",
             "players/jewel/room/hard2_1", "east", 
             "players/jewel/room/hard3", "south",
             "players/jewel/room/hard4_1","west"
           });
    }
    i = 0;
