...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for medi4_1";
       no_castle_flag = 0;
       long_desc = "blah blah blah. medi4_1.c\n";
       dest_dir = 
           ({"players/jewel/room/medi4_2", "south",
             "players/jewel/room/medi3_1", "east",
             "players/jewel/room/medi4", "north",
             "players/jewel/room/medi5_1", "west" 
           });
    }
    i = 0;
