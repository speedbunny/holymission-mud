...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for medi4_2";
       no_castle_flag = 0;
       long_desc = "blah blah blah. medi4_2.c\n";
       dest_dir = 
           ({"players/jewel/room/medi4_3", "south",
            "players/jewel/room/medi3_2", "east",
            "players/jewel/room/medi4_1", "north",
            "players/jewel/room/medi5_2", "west" 
           });
    }
    i = 0;
