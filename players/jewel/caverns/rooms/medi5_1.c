...
reset(arg) 
{
    ...
    {
       set_light(0);
       short_desc = "short for medi5_1";
       no_castle_flag = 0;
       long_desc = "blah blah blah. medi5_1.c\n";
       dest_dir = 
           ({"players/jewel/room/medi5_2", "south",
             "players/jewel/room/medi4_1", "east",
             "players/jewel/room/medi5", "north",
             "players/jewel/room/medi6_1", "west" 
           });
    }
    i = 0;
