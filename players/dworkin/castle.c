...
#include "/players/dworkin/area.h"

#define DEST "/players/dworkin/workroom"
...
make_quest() {
      ...
      quest->set_weight(17);
      quest->set_killing(4);
      quest->set_short_hint("Cook dinner for Druid Lakmir");
      quest->set_hint(
"Druid Lakmir's resident cook has died! What makes this even worse is that\n"+
"he died whilst making the dinner and Lakmir's getting impatient.\n"+
"Go to his manager and ask for the job.\n");
      quest->add_quest();
}
...
short() { return "Dworkin's Castle (Skeeve I.M.)"; }
...
long() {
  int i;
  string str;
  str = "Dump of monsters in the area:\n";
