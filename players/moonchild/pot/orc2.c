...
//  cnt3 = 3 - random(3);
  ...
  items = ({
    "trail", "They go west and south",
    "valley", "It is just a valley",
    "mountains", "Huge mountains bar exit to the north and west"
  });
 
  dest_dir = ({
    "/players/moonchild/pot/orc1", "east",
