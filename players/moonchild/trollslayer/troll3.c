...
object troll,troll2,troll3,bush;
...
extra_reset() {
    ...
    if(!present("blackthorn bush")) {
	bush=clone_object("/guild/master"->query_dir(1)+"/poison/bush");
...
south() {
    if(present("troll") && !this_player()->query_immortal()) {
