 /*  ###################################################################
     ...
     ################################################################### */
/* modified by Renegade... HOPEFULLY Whisky don't mind, do you Whis?  :)
   I added in a few other functions such as imprison, eall, and hell.
*/
...
#define FILE     "/players/renegade/private/items/pointer:"
...
get() {
  ...
  write("Your dark pointer activates itself in your inventory.\n"+
        ...
        "you for ever and possibly cause you to be demoted.\n");                
        return ( 1 );
    }
   return;
}
...
long() {
   ...
   write("This is the pointer of "+name+".\n");
    ...
    write("It is a dark powerful tool for wizards.\n"+
         "It looks like a long black staff, with a strange magial aura.\n"+
...
init() {        
  ...
  if (APPR) {
   ...
   if ( WIZ ) {
    ...
    add_action("do_bolt","bolt");
    add_action("imprison","imprison"); 	     add_action("imprison","imp");
...
help(str) {
  ...
  write("Following commands are available:\n\n"+
    ...
    write("\n\n"+ 
  "fear <living>         APPR     # fears a living out of the room.\n"+
  ...
  "eall                    WIZ       # echoes to all.\n"+
  "imprison <living> (imp) WIZ       # imprisons a player character.\n"+
  "burn <living>           WIZ       # sends living to witches oven.\n"+
          ...
          for(i=1;i<sizeof(solved);i++) {
            ...
            write(ladjust(solved[i],18));
             ...
             for (j=1;j<sizeof(quests);j++) {
                 ...
                 write(ladjust(quests[j]->query_weight(),4));
...
/* ********** Imprison function added by Renegade **************** */
...
/* ********** Burn function added by Renegade **************** */
...
/* ********** Echo all function added by Renegade **************** */
...
/* ********** Fear function added by Renegade **************** */
