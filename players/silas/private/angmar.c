...
west() {
  call_other (this_player(),"move_player","west#players/silas/workroom");
  return 1;
}
...
create_spirit() {
  ...
  call_other(spirit,"set_ac",8);
  call_other(spirit,"set_al",-100);
  ...
  call_other(spirit,"set_spell_mess2","The spirit throws a fire "+
              "elemental at you.");
  call_other(spirit,"set_chance",30);
  call_other(spirit,"set_spell_dam",35);
 
doomsgiver = clone_object("players/silas/weapon/oakstaff");
