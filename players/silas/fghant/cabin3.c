...
push(str) {
  if (str=="blue button") {
     write("A blue flash blinds you and you feel a slight skyward pull.\n");
     this_player()->move_player("fades away#players/silas/fghant/cabin");
     return 1;
  }
  if (str=="red button") {
     write("A red flash blinds you and you feel a slight earthward pull.\n");
     this_player()->move_player("fades away#players/silas/fghant/cabin2");
     return 1;
  }
  if (str=="purple button") {
     write("Nothing happens.\n");
     say(this_player()->query_player()+" pushes the purple button.\n");
     return 1;
  }
}
read(str) {
