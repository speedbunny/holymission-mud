...
get(){return 1;}
short(){ return "A potion of light healing";}
long(){
	write("This is a flask containing a potion of light healing. It may be possible\n");
	write("to drink it.\n");
	return 1;
}
drink(str){
	...
	say(this_player()->query_name()+" drinks the potion of light healing.\n");
