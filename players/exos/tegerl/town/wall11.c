...
long_desc=
    ...
    "To the east is the city-wall, to the west you can see a house entrance " +
    "There are people on the street and they seem to be busy.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/town/house7", "west",
    "players/tegerl/jabberwocky/rooms/town/wall12", "north",
    "players/tegerl/jabberwocky/rooms/town/wall10", "south",
  });
