...
clone_list=({1,2,"guard",PATH+"monsters/guard",0,
            ...
            3,3,"woman",PATH+"monsters/swoman",0,
...
dest_dir=({
    "players/tegerl/jabberwocky/rooms/town/wall7", "west",
    "players/tegerl/jabberwocky/rooms/town/house4", "north",
    "players/tegerl/jabberwocky/rooms/town/wall9", "east",
  });
