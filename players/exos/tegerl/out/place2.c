...
void reset(int arg) 
{
	...
	"To the south lies a forest and further to the west you can see the entrance to " +
	"the town. To the north you can see a city-wall.\n";

	dest_dir=({
	  "players/tegerl/jabberwocky/rooms/out/place1", "west",
	  "players/tegerl/jabberwocky/rooms/out/place3", "east",
	});
