...
void reset( int arg ) {
    ...
    set_gender( 2 );
    set_race( "dragon" );
    set_short( "Kizzyrlva, the Forest Dragon" );
    set_long( "\
This is the great Kizzyrlva.  She has been both the ally and foe of the\n\
elves of Regulost.  She is easily over 100 feet long, and nearly 50 feet\n\
tall.  Her emerald green scales glimmer in the light.  She looks upon you\n\
as someone totally unworthy of her attention.\n" );
    set_size( 6 );
    set_aggressive( 0 );
