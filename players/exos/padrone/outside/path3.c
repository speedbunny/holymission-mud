...
reset(arg) 
{
    ...
    if (arg == 0)
    {
       set_light(1);
       dest_dir = ({
       "players/padrone/outside/crossing", "north",
       "players/padrone/outside/front_yard", "south",
       });
       short_desc = "On a small path";
       long_desc =
       "You are on a small path winding through the bushes.\n"+
       "This is the place where Mathilda the thief is waiting\n"+
       "for people to pass by and rob them. Or for some handsome\n"+
       "males to get them and push them lustfully into the bushes.\n";
      }
}
