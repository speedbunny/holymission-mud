...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge10","north",
	  "/players/exos/forest/edge12","south",
	  "/players/exos/forest/28","northeast",
	  "/players/exos/forest/40","east",
	  "/players/exos/forest/50","southeast",
	});
    }
