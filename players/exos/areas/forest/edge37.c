...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge36","south",
	  "/players/exos/forest/edge38","north",
	  "/players/exos/forest/154","southwest",
	  "/players/exos/forest/141","west",
	  "/players/exos/forest/124","northwest",
	});
    }
