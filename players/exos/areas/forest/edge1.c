...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge54","east",
	  "/players/exos/forest/edge2","west",
	  "/players/exos/forest/1","southwest",
	  "/players/exos/forest/2","south",
	  "/players/exos/forest/3","southeast",
	});
    }
