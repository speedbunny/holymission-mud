...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge3","northeast",
	  "/players/exos/forest/edge5","southwest",
	  "/players/exos/forest/17","south",
	  "/players/exos/forest/18","southeast",
	  "/players/exos/forest/5","east",
	});
    }
