...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge41","southeast",
	  "/players/exos/forest/edge43","northwest",
	  "/players/exos/forest/78","south",
	  "/players/exos/forest/77","southwest",
	  "/players/exos/forest/67","west",
	});
    }
