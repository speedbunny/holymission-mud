...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge8","northeast",
	  "/players/exos/forest/edge10","southwest",
	  "/players/exos/forest/28","south",
	  "/players/exos/forest/29","southeast",
	  "/players/exos/forest/14","east",
	});
    }
