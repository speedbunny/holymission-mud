...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge43","south",
	  "/players/exos/forest/edge45","north",
	  "/players/exos/forest/57","southwest",
	  "/players/exos/forest/49","west",
	  "/players/exos/forest/39","northwest",
	});
    }
