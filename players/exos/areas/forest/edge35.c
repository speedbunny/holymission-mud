...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge34","southwest",
	  "/players/exos/forest/edge36","northeast",
	  "/players/exos/forest/160","west",
	  "/players/exos/forest/153","northwest",
	  "/players/exos/forest/154","north",
	});
    }
