...
way into the forest from here.\n";
	items=({ });
	dest_dir=({
	  "/players/exos/forest/edge51","southeast",
	  "/players/exos/forest/edge53","northwest",
	  "/players/exos/forest/4","west",
	  "/players/exos/forest/9","southwest",
	  "/players/exos/forest/10","south",
	});
    }
