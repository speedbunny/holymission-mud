...
#define TPRN capitalize(TP()->query_real_name())
...
reset(arg) {
  ...
  name=TPRN;
    ...
    set_long("This very sturdy looking rock was probably coded by Arthur.\n"+
     "It has many neat functions built into it. To learn more about the set\n"+
     "function type 'help set', and to learn more about the add function\n"+
     "type 'help add'.\n");
     set_value(1);
    set_weight(0);
  }
