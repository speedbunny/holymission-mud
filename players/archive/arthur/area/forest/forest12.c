...
reset(arg) {
   ...
   + "you body. You have a feeling that you are safe here, You only wish that\n"
   + "you would never have to leave this part of the forest again.\n"
   + "\n";
    dest_dir = ({
        "players/arthur/area/forest/forest19", "north",
        "players/arthur/area/forest/forest3", "southwest",
        });
    items = ({
     });
   }
