...
reset(arg) {
   ...
   + "which gives you the feeling that monsters would thend to hideout here more\n"
   + "often than some of the other rooms.\n"
   + "\n";
    dest_dir = ({
        "players/arthur/area/forest/forest20", "northeast",
        "players/arthur/area/forest/forest6", "south",
        });
    items = ({
     });
   }
