...
joke_1() {
    if (i == 2) {
    tell_object(plyr, "You have a fealing that someone is watching you.\n");}
    if (i == 4) {
    tell_object(plyr, "Someone taps you on the shoulder.\n");}
    if (i == 5) {
    tell_object(plyr, "Someone try's to steal somthing from you.\n");}
    if (i == 6) {
    tell_object(plyr, "Someone starts following you.\n");}
    if (i == 7) { 
    tell_object(plyr, "Someone says: Hehehehe\n");}
    if (i == 8) {
    tell_object(plyr, "Someone says: I am gonna steal ya blind\n");}
    if (i == 9) {
    tell_object(plyr, "#Someone backstabs you.\n");}
    if (i == 10) {
    tell_object(plyr, "You die.\n");}
    if (i == 13) {
    tell_object(plyr, "Someone says: Have you ever heard of a JOKE?\n");}
    if (i == 14) {
    tell_object(plyr, "Arthur tells ja: This joke brought to you by me, and "+tpn+".\n");}
