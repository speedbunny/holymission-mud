...
reset(arg) {
    ...
    if(!arg) {
        ...
        long_desc=
"                   This is Morrolan's workroom\n"
           
"            There ain't much to see here except maybe the many\n"
"            full ashtrays around his desk and the picture of\n"
"            Griffon sitting right next to his computer\n"
"            All in all you find it very boring here and no longer wonder\n"
"            why Morrolan is never here.",
