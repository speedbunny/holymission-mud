	...
	dest_dir = ({
		"players/titan/quest/rooms/wall3","south",
		"players/titan/quest/rooms/wall1","west",
		"players/titan/quest/rooms/tower2","down",
		"players/titan/quest/rooms/tower22","up"});
