	...
	long_desc = 
		"You have entered into the sea. In front of you spreads a beautiful gulf.\n"
	...
	dest_dir =
	      ({"players/titan/quest/rooms/beach2","beach",
	...
	this_player()->move_player("into the sea#players/titan/quest/rooms/more2");
        return 1;
}
	else {                           
