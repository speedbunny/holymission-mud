	...
	dest_dir = ({
		"players/titan/quest/rooms/wall2","south",
		"players/titan/quest/rooms/wall1","east",
		"players/titan/quest/rooms/kitchen","down",
		"players/titan/quest/rooms/tower12","up"});
