...
THREE_EXIT("players/nylakoorub/clearing/path/rooms/c006","north",
           "players/herp/orc/v2","west",
	 "players/herp/orc/v1","east",
	 "The orc valley",
	 "You are in the orc valley. This place is inhabitated by orcs.\n" +
         "Your nose is touched by the strong smell of orc urine.\n" +
         "A very large clearing lies to the north.\n",1)
