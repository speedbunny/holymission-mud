...
object orc, wp;
  ...
  if (!present("ogre"))
	...
	case 1 : w_name="small morningstar"; class=12; value=100; weight=4; alt_name="morningstar"; type=1; break;
        case 2 : w_name="wooden club";class=9; value=50; weight=3; alt_name="club"; type=1; break;
	}
...
TWO_EXIT("players/herp/orc/v4","south",
	 "players/herp/orc/u3","east",
	 "The orc valley",
