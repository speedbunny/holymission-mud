...
"The Frost King blows a smoke ring and sends it sailing up to the ceiling.\n";
    chat_str[1] =
"The Frost King relaxes in his armchair...\n";
    chat_str[2] = 
"The Frost King ponders on a logical puzzle for a few moments.\n";
    function = allocate(2);
    type = allocate(2);
    match = allocate(2);
