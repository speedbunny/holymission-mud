...
"Here, there is very little water for you to swim in.  The\n"+
"moat seems to be quite shallow at this point in the moat.\n"+
"It would seem however that you can swim back to the east.\n";
    no_obvious_msg = "";
...
"This is full of mud, and muck, which is making visibility very limited",
  "water",
"There is not as much of it around as elsewhere",
    });
...
int swim(string str)
{
  if (str == "west" || str == "w")
  {
    write("You honestly don't think you can swim in that direction,\n"+
	  "since there is very little water there.\n");
    return 1;
  }
  if (str == "east" || str == "e")
  {
    ...
    MPL("swimming east#/players/tamina/castle/rooms/umoat3");
  ...
  if (!str || str == "up" || str == "u")
  {
    ...
    MPL("swimming upwards#/players/tamina/castle/rooms/moat31");
