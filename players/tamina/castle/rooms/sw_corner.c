/*  This is the South-West Corner of the quad  */
...
"the claustraphobic atmosphere of the dusty passage-ways of the castle.\n"+
"From where you are, you can see that you stand in the south-west corner\n"+
"of a large Quadrangle in the rear part of Camelot.  This is a large square\n"+ 
"of grass, emclosed by  four cloistered path-ways\n";

	dest_dir = ({
          CROOMS + "w_cloister","north",
          CROOMS + "wwing10","west",
          CROOMS + "s_cloister","east",
        });
