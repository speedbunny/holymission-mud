...
int go_n()
{
  if (exit_num == 0)
  {
    MPL("north#/players/tamina/castle/planes/air/rm4");
...
int go_e()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("east#/players/tamina/castle/planes/air/rm4");
    return 1;
  }
  else
...
int go_w()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("west#/players/tamina/castle/planes/air/rm4");
    return 1;
  }
  else
...
int go_ne()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("northeast#/players/tamina/castle/planes/air/rm4");
    return 1;
  }
  else
...
int go_nw()
{
  if (exit_num == 5)
  {
    ...
    MPL("northwest#/players/tamina/castle/planes/air/rm1");
  return 1;
}
...
int go_se()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("southeast#/players/tamina/castle/planes/air/rm4");
    return 1;
  }
  else
...
int go_sw()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("southwest#/players/tamina/castle/planes/air/rm4");
    return 1;
  }
  else
