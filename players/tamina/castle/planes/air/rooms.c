...
{
  if (exit_num == 0)
    MPL("north#/players/tamina/castle/planes/air/rm1");
  else
    MPL("north#/players/tamina/castle/planes/air/rm2");
  return 1;
}
...
{
  if (exit_num == 1)
    MPL("south#/players/tamina/castle/planes/air/rm3");
  else
...
int go_e()
{
  if (exit_num == 2)
    ...
    MPL("east#/players/tamina/castle/planes/air/rm6");
  return 1;
}
...
int go_w()
{
  if (exit_num == 3)
    ...
    MPL("west#/players/tamina/castle/planes/air/rm8");
  return 1;
}
...
{
  if (exit_num == 4)
    MPL("northeast#/players/tamina/castle/planes/air/rm9");
  else
    MPL("northeast#/players/tamina/castle/planes/air/rm0");
  return 1;
}
...
{
  if (exit_num == 5)
    MPL("northwest#/players/tamina/castle/planes/air/rm11");
  else
    MPL("northwest#/players/tamina/castle/planes/air/rm12");
  return 1;
}
...
{
  if (exit_num == 6)
    MPL("southeast#/players/tamina/castle/planes/air/rm13");
  else
    MPL("southeast#/players/tamina/castle/planes/air/rm14");
  return 1;
}
...
{
  if (exit_num == 7)
    MPL("southwest#/players/tamina/castle/planes/air/rm15");
  else
    MPL("southwest#/players/tamina/castle/planes/air/rm16");
  return 1;
}
