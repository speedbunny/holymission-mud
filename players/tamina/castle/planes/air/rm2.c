...
int go_e()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("east#/players/tamina/castle/planes/air/rm3");
    return 1;
  }
  else
    MPL("east#/players/tamina/castle/planes/air/rm2");
  return 1;
}
...
int go_w()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("west#/players/tamina/castle/planes/air/rm3");
    return 1;
  }
  else
    MPL("west#/players/tamina/castle/planes/air/rm1");
  return 1;
}
...
int go_ne()
{
  if (exit_num == 4)
  {
    ...
    MPL("northeast#/players/tamina/castle/planes/air/rm1");
  return 1;
}
...
int go_nw()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("northwest#/players/tamina/castle/planes/air/rm3");
    return 1;
  }
  else
    MPL("northwest#/players/tamina/castle/planes/air/rm2");
  return 1;
}
...
int go_se()
{
  if (exit_num == 6)
  {
    ...
    MPL("southeast#/players/tamina/castle/planes/air/rm2");
  return 1;
}
...
int go_sw()
{
  ...
  {
    write("   You feel you have advanced somewhat...\n");
    MPL("southwest#/players/tamina/castle/planes/air/rm3");
    return 1;
  }
  else
    MPL("southwest#/players/tamina/castle/planes/air/rm1");
  return 1;
}
