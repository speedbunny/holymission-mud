...
void reset(int arg) 
{
  ...
  "Perhaps you could get this item identified.\n");
    set_value(1500);
    set_ac(1);
    set_weight(4);
...
string query_info()
{
  return "This is a powerful magical Helmet.  It can be used to find\n"+
         "your comrades currently on the Mission.\n";
}
...
seek (target)  
{
  ...
  ob2 = environment(ob);
// 151297: Suaron: Added block when 'seeking' immortals.
  if (!ob2 || ob->query_immortal())
  { 
    write("The Helmet was unable to seek out "+CAP(target)+".\n"); 
    return 1; 
  }
  write("Your Helmet glows brightly as you try to seek out "+CAP(target)+"...\n"+
        "You get a clear vision of: \n\n");
  ob2->long();
