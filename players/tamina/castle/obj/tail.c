...
int _pierce(string victim)
{
  ...
  if (!TP->query_attack())
  {
    write("You are not so experienced as to inflict the poison while not in combat !!\n");
    return 1;
  }
  if (in_progress)
  {
