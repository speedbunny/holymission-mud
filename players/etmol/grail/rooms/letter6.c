...
set_light(0); 
short_desc = "L"; 
long_desc = "You are standing on the letter L.\n"+
            "Around you are squares with the letters D, P, E and O.\n";
...
items = ({
          ...
          "P", "It looks safe to step on.",
          "O", "It looks safe to step on.",
          "L", "You are standing on it."
...
TP->move_player("to the square with the letter E on it#/players/etmol/grail/rooms/letter7");
return 1;
}
