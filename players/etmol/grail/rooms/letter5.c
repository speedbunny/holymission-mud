...
long_desc = "You are standing on the letter H.\n"+
            "Around you are squares with the letters E, L, A and S.\n";
...
correct()
{
write("You step on the letter L.\n");
TP->move_player("to the square with the letter L on it#/players/etmol/grail/rooms/letter6");
return 1;
}
