...
set_light(0); 
short_desc = "B"; 
long_desc = "You are standing on the letter B.\n"+
            "Around you are squares with the letters E, A, Y and R.\n";
...
items = ({
          ...
          "Y", "It looks safe to step on.",
          "R", "It looks safe to step on.",
          "B", "You are standing on it."
...
TP->move_player("to the square with the letter E on it#/players/etmol/grail/rooms/letter3");
return 1;
}
