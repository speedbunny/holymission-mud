...
long_desc=break_string(
	...
	"on this island.  The path slopes its way up the side of the "+
        "the mountain, however a massive rock slide has blocked the path "+
        "and will not allow anyone to pass.\n",65);
  dest_dir=({
	MPATH+"m2","northwest",
   });
   items=({
