...
long_desc=break_string(
	...
	"to the horizon to the east. Strange noises eminate from the "+
	"jungle to the west. The tide washes over the black sand of the "+
	"beach.  "+
	"A small village lies to the northeast, while the coast "+
	"continues southwest.\n",65);
...
dest_dir=({
	IPATH+"beach13","southwest",
	CPATH+"vill1","northeast",
	IPATH+"jung49","west",
	});
}
void init(){
