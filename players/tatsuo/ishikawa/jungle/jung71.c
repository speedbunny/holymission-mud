...
dest_dir=({
	IPATH+"jung82","northeast",
	IPATH+"jung72","east",
	IPATH+"jung59","south",
	IPATH+"jung58","southwest",
	});
}
void init(){
::init();
...
_south(){
if(present(slash,TP)){
MOVE("hacking "+TPOSS+" way south#players/tatsuo/ishikawa/jungle/jung59");
return 1;
}
else
...
_east(){
if(present(slash,TP)){
MOVE("hacking "+TPOSS+" way east#players/tatsuo/ishikawa/jungle/jung72");
return 1;
}
else{
write("You don't have anything that could cut through the foliage.\n");
