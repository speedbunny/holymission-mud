...
dest_dir=({
	IPATH+"jung81","northwest",
	IPATH+"jung69","west",
	IPATH+"jung55","south",
	IPATH+"jung56","southeast",
	});
}
void init(){
::init();
...
_south(){
if(present(slash,TP)){
MOVE("hacking "+TPOSS+" way south#players/tatsuo/ishikawa/jungle/jung55");
return 1;
}
else
...
_west(){
if(present(slash,TP)){
MOVE("hacking "+TPOSS+" way west#players/tatsuo/ishikawa/jungle/jung69");
return 1;
}
else{
write("You don't have anything that could cut through the foliage.\n");
