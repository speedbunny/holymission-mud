...
say("<><><><><><><><><><><><><><><><><><><><><><><><><><><><><>\n");
say(TPN+" introduces "+TP->query_objective()+"self\n");
say("<><><><><><><><><><><><><><><><><><><><><><><><><><><><><>\n");
say("                                                          \n");
say("           I am "+kskill+" in Karate Jitsu             \n");
say("           I am "+sskill+" in Chimmoku Waza            \n");
say("           I am "+asskill+" in Assassination           \n");
say("           I am "+thkill+" in Throwing                \n");
say("           I am "+brkill+" in Breaking                \n");
say("           I am "+dikill+" in Disarming               \n");
say("           I am "+smkill+" in Shadow Magic               \n");
say("           I am "+kuskill+" in Kubudo Jitsu            \n");
say("                                                          \n");
say("<><><><><><><><><><><><><><><><><><><><><><><><><><><><><>\n");

write("You introduce yourself as:\n\n");
"/players/tatsuo/guild/bin/skills"->main();
return 1;
} 
