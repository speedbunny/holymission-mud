...
/* 180394: Roland (whisky): put out Cashis code because the query dont exist */
...
do_earthgrip( arg )
{
   ...
   if (!who->query_npc() && !who->query_immortal())
   {
      write( "This spell won't work at players.\n" );
      return( 1 );
   }
   /* commented out: whisky
