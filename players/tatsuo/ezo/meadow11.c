...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        ...
        "northeast is the southwestern corner of a house and to the south,\n" +
        "southwest and west is the rock face of the volcano crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
        ...
        "corner", "It is the southwestern corner of the wall",
   ...
   dest_dir=({
	PPATH + "meadow12","north",
        PPATH + "meadow10", "east",
        PPATH + "meadow26", "southeast",
        PPATH + "meadow27", "northwest",
   });
}
