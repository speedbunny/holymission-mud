...
handle_insane() {
   ...
   switch( random( 100 ) ) {
      ...
      case 6..14:  tell_object(mad,"You can see white mice creeping over you"+
		   "!!!\n");
                   break;
      case 15..22: tell_object(mad,"A white mouse bites you on your nose!!!\n");
                   break;
      case 23..29: tell_object(mad,"Beetles are creeping out of your mouth"+
		   "!!!\n");
                   break;
      case 30..35: shout( capitalize( mad->query_real_name() ) + " shouts: " +
                     "Please help me, I don't want to die !!!\n" ); 
                   break;
      case 36..43: tell_object( mad, "You giggle insanly.\n" );
                   break;
      case 44..50: tell_object( mad, "You can see your back !\n" );
                   break;
      case 51..58: tell_object( mad, "You smile at your feet.\n" );
                   break;
