...
{
if(!present("tablet")){
move_object(clone_object("/players/tatsuo/ezo/forest/tablet"),this_object() );
}
   if ( arg )
      return;
   ...
   long_desc = "You are standing in a big valley. The ground here is grassy and a wall\n" +
               "zooms up at your western side. There is blood on the grass and deep\n" +
               "scratches at the wall. Blood is also on the ground. You feel feard!\n" +
               "The valley narrows to the south.\n";
   ...
   dest_dir = ({ PPATH + "valley4", "southeast",
                 PPATH + "rl2",     "down",
                 PPATH + "valley2", "east",
              });
