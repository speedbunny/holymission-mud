...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        "The ground here is grassy and there are flowers here. To the southeast,\n" +
        "south and southwest is the rock face of the volcano crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
	...
	"volcano crater","You're in the crater, just look aound to see more",
	"volcano","You're inside the crater, just look around to see more",
   });
   smell = "You smell the odor of grass.";
   dest_dir=({
	PPATH + "meadow9","north",
        PPATH + "meadow8",  "northeast",
       PPATH + "meadow24", "east",
       PPATH + "meadow26", "west",
       PPATH + "meadow10", "northwest",
   });
}
