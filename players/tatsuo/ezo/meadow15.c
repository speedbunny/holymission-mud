...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        ...
        "southeast is the nrthwestern corner of a house and to the\n" +
        "northwest is the rock face of the volcano crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
        ...
        "corner", "It is the northwestern corner of the wall",
        "wall", "The wall is made of wood and looks very strong",
        "wood", "It is teak",
	"rock face","You think that the rock face almost extends to eternity",
   ...
   dest_dir=({
	PPATH + "meadow31","north",
        PPATH + "meadow32", "northeast",
        PPATH + "meadow16", "east",
        PPATH + "meadow14", "south",
        PPATH + "meadow29", "southwest",
        PPATH + "meadow30",  "west",
   });
}
