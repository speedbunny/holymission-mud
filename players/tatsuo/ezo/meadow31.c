...
reset(arg) {
   ...
   long_desc=
	"You are standing in a meadow in a hollow of the island of Ezo.\n"+
        ...
        "northeast, west, and northwest is the rock face of the volcano\n"+
	"crater.\n";
   items=({
	"meadow", long_desc,
        "hollow", long_desc,
	...
	"volcano","You're inside it, just look around to see more of it",
   });
   smell = "You smell the odor of grass.";
   dest_dir=({
	PPATH + "meadow32","east",
                 PPATH + "meadow25", "south",
	PPATH + "meadow16","southeast",
	PPATH + "meadow30","southwest",
   });
}
