...
reset( arg )
{
   ...
   long_desc = 
        ...
        "that even the ceiling is beyond your sight. To the east is a large\n"+
...
int do_unlock( string what )
{
   ...
   write( "There is no keyhole in the gate.\n" );
   return( 1 );
}
...
int do_yell( string what )
{
  if( what != "In the name of Amaterasu, I command thee to open" )
   ...
   TP->move_player( "through the portal#"+PPATH+"link15" );
