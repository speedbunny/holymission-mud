...
reset( arg )
{
   ...
   set_rf_dirs( "southwest, west and northwest" );
   set_coast_dirs( "northeast, east, southeast and south" );
   ...
   items = ({ "slope", long_desc,
              ...
              "rock face", "You think that the rock face almost rises into eternity",
...
swim_it( arg )
{
   ...
   else if ( arg == "south" || arg == "to shore" || arg == "to the shore" ) {
...
build_long_desc( )
{
   ...
   s = "You are standing on a slope of the island of Ezo. The ground consists of\n" +
       ...
       "In some distance to the south can you see a shore.\n";
