...
reset(arg) {
  if(!arg) {
    short_desc="South in the Arena";
    long_desc="South in the Arena.  This is where you have come to\n"
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena8")) write("And here is : ");
}  
