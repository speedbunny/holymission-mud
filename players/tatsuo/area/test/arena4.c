...
reset(arg) {
  if(!arg) {
    short_desc="West in the Arena";
    long_desc="West in the Arena.  This is where you have come to\n"
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena4")) write("And here is : ");
}  
