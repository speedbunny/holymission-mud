...
reset(arg) {
  if(!arg) {
    short_desc="Southeast in the Arena";
    long_desc="Southeast in the Arena.  This is where you have come to\n"
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena9")) write("And here is : ");
}  
