...
reset(arg) {
  if(!arg) {
    short_desc="Southwest in the Arena";
    long_desc="Southwest in the Arena.  This is where you have come to\n"
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena7")) write("And here is : ");
}  
