...
reset(arg) {
  if(!arg) {
    short_desc="East in the Arena";
    long_desc="East in the Arena.  This is where you have come to\n"
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena6")) write("And here is : ");
}  
