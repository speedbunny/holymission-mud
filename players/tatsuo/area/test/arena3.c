...
reset(arg) {
  if(!arg) {
    short_desc="Northeast in the Arena";
 
    long_desc="Northeast in the Arena.  This is where you have come to\n"
    ...
    set_light(1);
    dest_dir=({FPATH+"arena2","west"
    	      ,FPATH+"arena5","southwest"
	      ,FPATH+"arena6","south"
	    });
       items=({
...
long(a) {
  ...
  if(fl && get_inv_list(FPATH+"arena3")) write("And here is : ");
}  
