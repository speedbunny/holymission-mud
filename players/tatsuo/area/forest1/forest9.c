...
"Noises come from all around you, and you feel watched.  You see a\n"+
"tent to the south.  A large palisade lies to the west.\n";

   dest_dir=({
            F1PATH+"shop_tent.c", "south",
            F1PATH+"forest10.c",  "north",
	    F1PATH+"forest7.c",   "east",
     });
   items=({ 
