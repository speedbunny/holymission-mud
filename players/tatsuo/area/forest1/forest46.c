...
"Noises come from all around you, and you feel watched.\n";
   ...
   dest_dir=({
            F1PATH+"forest45.c", "north",
            F1PATH+"forest47.c", "south",
	    F1PATH+"forest42.c", "east",
	    F2PATH+"forest51.c", "west",
     });
   items=({ 
    ...
    clone_x_of_y((ran_monsters-(filter_live(this_object(),"slave"))),MPATH+"forest_monster.c");
}
