...
"Noises come from all around you, and you feel watched.  A mountain\n"+
"rises up to the south, and you are unable to climb it.\n";

   dest_dir=({
            F1PATH+"forest46.c","east",
            F2PATH+"forest53.c","north",
            F2PATH+"forest62.c","northwest",
	    F2PATH+"forest51.c","southeast",
     });
   items=({ 
