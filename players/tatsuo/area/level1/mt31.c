...
"some of the larger stones.  It is unnaturally quiet, and a large cave-in\n"+
"is to the north.  Cart tracks extend across the room going south and the.\n"+
"cave-in covers the track going north.\n";
   dest_dir=({
            L1PATH+"mt4.c",  "south",
	  });
   items=({
     ...
     "dead-end","A stone wall looms up before you",
   });
