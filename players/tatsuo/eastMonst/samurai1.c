...
reset( arg )
{
   ...
   set_name("samurai");
   set_alt_name("guard");
   set_alias("samurai guard");
   set_level(99);
   set_short("A samurai guard");
   set_long(
  ...
  load_chat(20,(
            { "The samurai guard looks around.\n",
              "The samurai guard looks critically at you.\n",
            }));
  load_a_chat(20,(
            { "The samurai guard growls at you.\n",
              "The samurai guard says: I kill you bastard.\n",
            }));

  set_chance(10);
  set_spell_mess1( "hits you critically." );
  set_spell_mess2( "hits you with his foot." );
...
/*
  ...
  sword=clone_object("/players/tatsuo/GenObj/weapon");
