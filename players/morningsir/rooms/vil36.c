...
reset(arg) {
  ...
  long_desc=
   ...
   "while beggars sit on the road and gaze at you. The main street goes from east\n" +
   "and turns northwest to the main square. You can see houses of the village and\n" +
   "there is also a sound of marketplace coming from the northwest.\n";

  dest_dir=({ PATHR + "vil34.c", "west",
              PATHR + "vil37.c", "east",
              PATHR + "vil33.c", "northwest",
              PATHR + "vil35.c", "north"
             });
