...
reset(arg){
  ...
  long_desc = 
      ...
      "To the southeast is a large stairwell leading up into the heart of the castle.  "+
      "The hall leads on to the southwest.\n";
  dest_dir=({
      HAM+"room/hall15", "southeast",
      HAM+"room/hall11", "southwest",
  });
  items=({
