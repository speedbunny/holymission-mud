...
reset(arg){
  ...
  long_desc = 
      ...
      "can be heard in the distance.  A small ladder is resting against one of the walls.  "+
      "The passage leads towards the south and northeast.\n";
  dest_dir=({
      HAM+"room/pass5", "south",
      HAM+"room/pass2", "northeast",
      HAM+"room/stage", "up",
  });
  items=({
      "stones", "Cold gray stones making up the entire passage",
      "ladder", "A small ladder leading up",
