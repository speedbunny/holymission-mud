...
void reset( int arg ) {
  ...
  long_desc = "You are in the dark cellar of the Mages Tower.  "
    + "It is cold and musty here, but the smell of fresh cheese "
    + "overpowers your senses.  The smell makes your mouth water.  "
    + "There is a cellar door on the west wall.  "
    + "The cellar is made from old, slightly rotting wood.\n";
  dest_dir = ({
    ROOM + "c4", "west",
    ROOM + "c1", "south",
  });
