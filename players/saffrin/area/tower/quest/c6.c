...
void reset( int arg ) {
  ...
  long_desc = "You are in the dark and cold cellar of the Mage Tower.  "
    + "This room is west and musty from age.  The smell of cheese is "
    + "very powerful here, making you drool.  There is a rather small "
    + "hole in the eastern wall.  The corridor leads north from here and "
    +"there is a cellar door to the west.\n";
  dest_dir = ({
    ROOM+"c1","north",
    ROOM+"c5","west"
  });
