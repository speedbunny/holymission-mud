...
reset(arg){
  ...
  long_desc =
       ...
       "west quartz wall.  Rose bushes line the northwest and southwest corners.  "+
       "The walls are made from clear quartz panels, allowing light to set in the "+
       "garden.  The garden continues to the northeast and southeast.\n";
  dest_dir=({
      TOWER+"room/garden1", "northeast",
      TOWER+"room/garden3", "southeast",
  });
  items=({
