...
reset(arg){
  ...
  long_desc =
        ...
        "The view of the land expands to the north of the tower.  A moonstone "+
         "railing is on the north edge, protecting all from falling.  The battlements "+
        "continue to the southeast and southwest.  A stairwell back into the "+
        "tower is to the south.\n";
  dest_dir=({
      TOWER+"room/top", "south",
      TOWER+"room/b4", "southeast",
      TOWER+"room/b2", "southwest",
  });
  items=({
