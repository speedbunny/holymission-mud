...
reset(arg){
  ...
  long_desc =
       ...
       "south quartz wall.  Rose bushes line the southeast and southwest corners.  "+
       "The walls are made from clear quartz panels, allowing light to set in the "+
       "garden.  The garden continues to the northeast and northwest.\n";
  dest_dir=({
      TOWER+"room/garden4", "northeast",
      TOWER+"room/garden2", "northwest",
  });
  items=({
