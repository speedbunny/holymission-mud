...
reset(arg){
    ...
    long_desc =
         ...
         "coins, velvet, and lace.  There are pillows and blankets on the floor for the "+
         "tinkers to sleep on.  There are candles placed all around the tent and "+
         "incense is burning in here.\n";
    dest_dir=({
      TINK+"room/path5", "south",
    });
    items=({
    ...
    clone_list=({
          1, 2, "boy", TINK+"npc/tboy", 0,
          1, 2, "girl", TINK+"npc/tgirl", 0,
    });
    ::reset();
