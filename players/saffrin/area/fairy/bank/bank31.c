...
reset(arg){
  ...
  long_desc = 
        ...
        "small mandrakes growing along the water's edge to the southeast of you.  "+
      	"Small white pebbles are scattered around you.  You can see a thick "+
      	"forest filled with trees in the north.  You can see the "+
      	"Knockaine Woods filled with willow trees to the west of you.   The bank "+
        "of the lake leads to the south and east.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"bank/bank32", "south",
        FAIRY+"bank/bank30", "east",
        FAIRY+"wood/wood61", "west",
        FAIRY+"water/lake26", "southeast",
  });
  items=({
