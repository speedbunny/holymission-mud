...
reset(arg){
  ...
  long_desc = 
        ...
        "the north and west of you.  There are several small moonworts growing along "+
        "the water's edge to the southwest of you.  The bank of the lake leads to "+
        "the south and west.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"bank/bank25", "south",
        FAIRY+"bank/bank27", "west",
        FAIRY+"water/lake23", "southwest",
  });
  items=({
