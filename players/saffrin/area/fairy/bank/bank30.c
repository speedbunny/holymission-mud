...
reset(arg){
  ...
  long_desc = 
        ...
        "forest filled with fir trees to the north of you.  The bank of the "+
        "lake leads to the east and west.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"water/lake26", "south",
        FAIRY+"bank/bank29", "east",
        FAIRY+"bank/bank31", "west",
  });
  items=({
