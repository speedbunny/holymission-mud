...
reset(arg){
  ...
  long_desc = 
	...
	"Lake.  The water of this lake is a rare silver color, that is said to have "+
        "been created from moondust.  Several waterlilies float on the surface "+
 	"of the water, adding a soft white touch to the silvery glow.  Glimmering "+
	"sparkles rain down from above, glistening you skin.  Strange lights fly "+
	"by your head, whispering chants in your ears.  To the west, Alfheim "+
      "Stream flows into the lake.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"water/lake39", "north",
        FAIRY+"bank/bank14", "south",
        FAIRY+"water/lake15", "east",
        FAIRY+"water/stream13", "west",
        FAIRY+"bank/bank37", "northwest",
  });
  items=({
