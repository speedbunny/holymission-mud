...
reset(arg){
  ...
  long_desc = 
	...
	"by your head, whispering chants in your ears.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"bank/bank30", "north",
        FAIRY+"water/lake27", "south",
        FAIRY+"water/lake25", "east",
        FAIRY+"bank/bank32", "west",
        FAIRY+"bank/bank31", "northwest",
  });
  items=({
