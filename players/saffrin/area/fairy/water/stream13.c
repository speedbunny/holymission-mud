...
reset(arg){
  ...
  long_desc = 
        ...
        "from the shimmering surface.  The stream flows into Lake Elphame to "+
        "the east.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"bank/bank37", "north",
        FAIRY+"bank/bank13", "south",
        FAIRY+"water/lake14", "east",
        FAIRY+"water/stream12", "west",
  });
  items=({
