...
reset(arg){
  ...
  long_desc = 
        ...
        "There are several water lilies growing up from the shimmering surface.  "+
        ...
        "causing small rapids to form.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"bank/bank48", "north",
        FAIRY+"bank/bank2", "south",
        FAIRY+"water/stream3", "east",
        FAIRY+"water/stream1", "west",
  });
  items=({
  ...
  clone_list=({
        1, 2, "attrocrope", FAIRY+"npc/attro", 0,
  });
  ::reset();
