...
reset(arg){
  ...
  long_desc = 
	...
	"Lake.  The water of this lake is a rare silver color, that is said to have "+
        "been created from moondust.  Strange lights fly "+
	"by your head, whispering chants in your ears.  Glimmering "+
	"sparkles rain down from above, glistening you skin.  Several waterlilies"+
        " float on the surface "+
 	"of the water, adding a soft white touch to the silvery glow.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"water/lake30", "north",
        FAIRY+"water/lake36", "south",
        FAIRY+"water/lake20", "east",
        FAIRY+"water/lake34", "west",
  });
  items=({
  ...
  clone_list=({
        1, 2, "attrogedd", FAIRY+"npc/attro", 0,
  });
  ::reset();
