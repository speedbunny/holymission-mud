...
reset(arg){
  ...
  long_desc = 
	...
	"Lilies of the valley are growing in patches all along the ground.  The branches "+
        "of the trees sweep down, giving the woods a curtained "+
	"sheltering atmosphere.  Around the base of each tree, there are "+
        "several mugworts, moonworts, and mandrakes sprouting up in their "+
        "own glory.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"wood/wood53", "north",
        FAIRY+"wood/wood29", "south",
        FAIRY+"wood/wood43", "east",
        FAIRY+"wood/wood45", "west",
  });
  items=({
