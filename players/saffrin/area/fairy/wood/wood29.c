...
reset(arg){
  ...
  long_desc = 
	...
	"sheltering atmosphere.  Around the base of each tree, there are several "+
	"mugworts, moonworts, and mandrakes sprouting up in their own glory.  Lilies "+
	"of the valley are growing in patches all along the ground.\n";
  smell="It smells like the sweetness of flowers.\n";
  dest_dir=({
        FAIRY+"wood/wood44", "north",
        FAIRY+"wood/wood20", "south",
        FAIRY+"wood/wood30", "east",
        FAIRY+"wood/wood28", "west",
  });
  items=({
