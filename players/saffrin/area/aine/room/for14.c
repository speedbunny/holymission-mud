...
reset(arg){
  ...
  long_desc = 
      ...
      "Branches block your way in several directions, hanging low enough to touch "+
      "the ground.\n";
  smell="The air smells sweet.\n";
  dest_dir=({
      AINE+"room/for18", "north",
      AINE+"room/for3", "south",
      AINE+"room/for15", "west",
  });
  items=({
  ...
  clone_list=({
      1, 1, "tree", AINE+"npc/sweet", 0,
      1, 1, "dryad", AINE+"npc/dryad", 0,
  });
  ::reset();
