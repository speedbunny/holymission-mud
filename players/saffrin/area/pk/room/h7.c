...
reset(arg){
  ...
  long_desc = 
      ...
      "northwest, and southeast of here.  "+
      ...
      "There is an entrance to an old courtyard to the southwest.  "+
  ...
  dest_dir=({
      ...
      PK+"room/h8", "east",
      PK+"room/h6", "west",
      PK+"room/r7", "northeast",
      PK+"room/r5", "northwest",
      PK+"room/r10", "southeast",
      PK+"room/c01", "southwest",
  });
  items=({
