...
reset(arg){
  ...
  long_desc = 
      ...
      "hot as it beats down on you.  The courtyard continues to the north, "+
      "west, and northwest.  "+
      "You can enter the asylum to the south and southwest.\n";
  property=({
      "no_teleport",
  });
  dest_dir=({
      ...
      PK+"room/h22", "south",
      PK+"room/c09", "west",
      PK+"room/c06", "northwest",
      PK+"room/h21", "southwest",
  });
  items=({
