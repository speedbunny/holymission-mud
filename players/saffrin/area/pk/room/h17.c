...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to the north, south, "+
      ...
      "There is an entrance to an old courtyard to the northwest.  "+
      "The hall continues to the east, west, northeast, and southeast.\n";
  property=({
      "no_teleport",
  });
  ...
  dest_dir=({
      ...
      PK+"room/h18", "east",
      PK+"room/h16", "west",
      PK+"room/h13", "northeast",
      PK+"room/c8", "northwest",
      PK+"room/h23", "southeast",
      PK+"room/r21", "southwest",
  });
  items=({
