...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to the north, "+
      "northeast, and southeast of here.  "+
      ...
      "There is an entrance to an old courtyard to the south.  "+
      "The hall continues to the east, west, and southeast.\n";
  property=({
      "no_teleport",
  });
  ...
  dest_dir=({
      ...
      PK+"room/h7", "east",
      PK+"room/h5", "west",
      PK+"room/r6", "northeast",
      PK+"room/r11", "southeast",
      PK+"room/h10", "southwest",
  });
  items=({
