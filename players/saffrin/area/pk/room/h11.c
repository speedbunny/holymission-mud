...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to east, west, "+
      "southeast, and southwest of here.  "+
      "The iron bars on the cells have rusted over due to lack of care.  "+
      "A foul stench assaults your nose and makes yoru eyes water.  "+
      "There is an entrance to an old courtyard to the northeast and northwest.  "+
  ...
  dest_dir=({
      ...
      PK+"room/r28", "east",
      PK+"room/r15", "west",
      PK+"room/c01", "northeast",
      PK+"room/c1", "northwest",
      PK+"room/r27", "southeast",
      PK+"room/r16", "southwest",
  });
  items=({
