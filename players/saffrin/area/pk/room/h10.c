...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to the southeast "+
      ...
      "There is an entrance to an old courtyard to the east and west.  "+
      "The hall continues to the north, south, northeast, and northwest.\n";
  property=({
      "no_teleport",
  });
  ...
  dest_dir=({
      ...
      PK+"room/c01", "east",
      PK+"room/c1", "west",
      PK+"room/h6", "northeast",
      PK+"room/h4", "northwest",
      PK+"room/r28", "southeast",
      PK+"room/r15", "southwest",
  });
  items=({
