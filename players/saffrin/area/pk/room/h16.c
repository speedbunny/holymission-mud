...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to the south, northeast, "+
      ...
      "There is an entrance to an old courtyard to the north and northwest.  "+
  ...
  dest_dir=({
      ...
      PK+"room/h17", "east",
      PK+"room/h15", "west",
      PK+"room/c9", "northwest",
      PK+"room/r22", "southeast",
      PK+"room/r20", "southwest",
  });
  items=({
