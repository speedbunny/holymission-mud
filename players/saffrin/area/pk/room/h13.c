...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to east, west, northeast, "+
      ...
      "The hall continues to the north, south, southeast, and southwest.\n";
  property=({
      "no_teleport",
  });
  ...
  dest_dir=({
      ...
      PK+"room/r18", "east",
      PK+"room/r17", "west",
      PK+"room/r27", "northeast",
      PK+"room/r16", "northwest",
      PK+"room/h19", "southeast",
      PK+"room/h17", "southwest",
  });
  items=({
