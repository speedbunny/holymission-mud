...
reset(arg){
  ...
  long_desc = 
      ...
      "There is an entrance to an old courtyard to the northeast.  "+
      "The hall continues to the east, west, northwest, and southwest.\n";
  property=({
      "no_teleport",
  });
  ...
  dest_dir=({
      ...
      PK+"room/h20", "east",
      PK+"room/h18", "west",
      PK+"room/c08", "northeast",
      PK+"room/r24", "southeast",
      PK+"room/h23", "southwest",
  });
  items=({
