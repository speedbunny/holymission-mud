...
reset(arg){
  ...
  long_desc = 
      ...
      "your way.  There are open cells to the south, northwest, "+
      ...
      "There is an entrance to an old courtyard to the north and northeast.  "+
  ...
  dest_dir=({
      ...
      PK+"room/h21", "east",
      PK+"room/h19", "west",
      PK+"room/c09", "northeast",
      PK+"room/r25", "southeast",
      PK+"room/r23", "southwest",
  });
  items=({
