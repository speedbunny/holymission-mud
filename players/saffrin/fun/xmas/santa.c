//  Saffrin fixed the spelling in this file
inherit "/obj/monster";
...
reset (arg) {
    ...
    set_long("He holds Huge, green christmas tree in his hand.\n"+
      "You feel nasty cold coming from his red coat.\n"+
      "Barely, you can see his eyes behind his hairy beard\n"+
      "and you feel that he is coming from far behind ...\n");
    set_race("human");
    set_level(30);
