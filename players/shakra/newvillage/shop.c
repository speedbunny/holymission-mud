...
void reset(int arg) {
  ...
  items = ({ "shop","This is the shop that serves this village",
          "buiding","Like most buildings, this is made of treestems",
          "walls","Walls of sturdy treestems",
          "treestems","Smoothed treestems, cut from the forest right out of the village",
