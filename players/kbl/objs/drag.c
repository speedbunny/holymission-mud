...
object bh;
  ...
  if (!arg) {
    ...
    move_object(clone_object("players/whisky/NEWWIZ/dragontail"),
    this_object()); /*the dragon gets a tail */
    init_command("wield tail"); /*the dragon should wield it */
}
}

monster_died(ob)
{
  say("You see the body of the dragon dissolve in thin air! The skeleton\n"+
