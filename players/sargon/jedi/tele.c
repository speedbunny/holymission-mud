...
int _con(string str) {
 ...
 else if(!TP->query_immortal() && (TP->query_guild()!=4)) {
        write("You concentrate as hard as you can, IT HURTS!\n");
}
    else return 0;
    return 1;
}
...
void reset(int arg) {
    ...
    long_desc =
              ...
              "sensitive mind. Many a jedi has labored to bring you this "+
              ...
              "walls with gafitti. As you lean closer you can just read it.\n\n"
+
