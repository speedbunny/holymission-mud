...
reset(arg) {
  ...
  if (arg) return;
    ...
    long_desc="This is the armoury of the once great general, Sledge.\n"+
              ...
              "information.\n";
    dest_dir= ({
              "/players/sargon/guild/rooms/hall", "north",
              });
    items=({
...
init() {
  ...
  */
    ...
    return 1;
      ...
      weight=2;
      short= "Boots";
      long=  "These are high quality combat boots fitted with steel toes.\n"+
             "They don't give the greatest protection but they are great \n"+
             "for kicking your opponent in the groin.\n\n";
      alias= "boots";
      name=  "boots";
      type=  "boot";
      w5++;
