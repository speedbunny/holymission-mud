...
int _hide_exit() {
    ...
    if (PATH) {
        ...
        TP->MO("through the bushes#/players/kelly/rooms/swamps/grass1");
    }
    else
...
void reset(int arg) {
    ...
    dest_dir=({
               "players/kelly/rooms/mythwood/clear2","south",
               "players/kelly/rooms/mythwood/clear4","east",
               "players/kelly/rooms/mythwood/clear1","southeast",
             });
