...
void reset(int arg) {
  ...
  long_desc=
    "You have entered the outer office of the police station. "+
    "There is a large number of desks placed about the room in "+
    "no apparent order.  The cells of the station are off to the "+
    "west and to the north is a bureau.  In the center of the "+
    "room there is a pole stretching up through a hole in the ceiling.\n";
  ...
  items=({
    ...
    "pole","It seems you can only slide down it. It is too "+
      "slippery to climb up",
  });
}
