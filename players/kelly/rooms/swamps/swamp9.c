...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp8","south",
    "players/kelly/rooms/swamps/swamp1","north",
    "players/kelly/rooms/swamps/swamp10","west",
    "players/kelly/rooms/swamps/swamp11","east",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw9");
  return 1;
}
