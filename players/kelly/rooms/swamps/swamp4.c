...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp11","south",
    "players/kelly/rooms/swamps/swamp1","west",
    "players/kelly/rooms/swamps/swamp8","north",
    "players/kelly/rooms/swamps/swamp2","east",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw4");
  return 1;
}
