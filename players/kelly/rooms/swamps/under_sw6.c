...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/under_sw7","west",
    "players/kelly/rooms/swamps/under_sw10","north",
    "players/kelly/rooms/swamps/under_sw2","south",
    "players/kelly/rooms/swamps/under_sw5","east",
   });
