...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp7","south",
    "players/kelly/rooms/swamps/swamp9","west",
    "players/kelly/rooms/swamps/swamp4","north",
    "players/kelly/rooms/swamps/swamp10","east",
   });
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw12");
  return 1;
}
