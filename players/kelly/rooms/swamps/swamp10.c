...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp5","south",
    "players/kelly/rooms/swamps/swamp11","west",
    "players/kelly/rooms/swamps/swamp2","north",
    "players/kelly/rooms/swamps/swamp12","east",
   });
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw10");
  return 1;
}
