...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp6","south",
    "players/kelly/rooms/swamps/swamp12","west",
    "players/kelly/rooms/swamps/swamp13","north",
    "players/kelly/rooms/swamps/swamp9","east",
   });
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw11");
  return 1;
}
