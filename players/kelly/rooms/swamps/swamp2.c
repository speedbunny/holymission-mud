...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp9","south",
    "players/kelly/rooms/swamps/swamp3","west",
    "players/kelly/rooms/swamps/swamp6","north",
    "players/kelly/rooms/swamps/swamp4","east",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw2");
  return 1;
}
