...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp2","south",
    "players/kelly/rooms/swamps/swamp5","west",
    "players/kelly/rooms/swamps/sw_entr","east",
    "players/kelly/rooms/swamps/swamp11","north",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw7");
  return 1;
}
