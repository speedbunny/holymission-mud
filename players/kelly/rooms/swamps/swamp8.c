...
reset(arg) {
    ...
    dest_dir=({
    "players/kelly/rooms/swamps/swamp3","south",
    "players/kelly/rooms/swamps/swamp12","north",
    "players/kelly/rooms/swamps/swamp6","west",
    "players/kelly/rooms/swamps/swamp7","east",
   });
   call_out("sink",30);
}
...
sink() {
  ...
  this_player()->move_player("into nowhere#players/kelly/rooms/swamps/under_sw8");
  return 1;
}
