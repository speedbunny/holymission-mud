#define PR "players/kelly/rooms/mountains/suspension"
...
east() {
  this_player()->move_player("east#players/kelly/rooms/mountains/path10");
  return 1;
}

west() {
  this_player()->move_player("west#players/kelly/rooms/mountains/path11");
  return 1;
}
...
climb() {
  if(PR->query_rope()) {
    ...
    this_player()->move_player("up#players/kelly/rooms/mountains/suspension");
    return 1; 
  }
