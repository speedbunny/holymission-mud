#define PR "players/kelly/rooms/mountains/specialpath3w"
...
se() {
  this_player()->move_player("southeast#players/kelly/rooms/mountains/specialpath2e");
  return 1;
}

north() {
  this_player()->move_player("north#players/kelly/rooms/mountains/path10");
  return 1;
}
