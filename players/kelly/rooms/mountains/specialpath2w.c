#define PR "players/kelly/rooms/mountains/specialpath2e"
...
sw() {
  this_player()->move_player("southwest#players/kelly/rooms/mountains/specialpath1w");
  return 1;
}

nw() {
  this_player()->move_player("northwest#players/kelly/rooms/mountains/specialpath3w");
  return 1;
}
