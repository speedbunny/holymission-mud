...
reset(arg) {
  ...
  dest_dir=({
    "players/kelly/rooms/mountains/plain2","north",
    "players/kelly/rooms/mountains/valley4s","northeast",
    "players/kelly/rooms/entwood/edge1","west",
    "players/kelly/rooms/mountains/rocks11","south",
    "players/kelly/rooms/mountains/rocks11","up",
   });
