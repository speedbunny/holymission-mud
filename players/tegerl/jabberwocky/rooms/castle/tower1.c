...
long_desc=
    "You are in a tower. You are on the ground floor and there " +
    "are stairs leading up. " +
    "There are no windows and it is cold in here.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/castle/hall4", "northeast",
    "players/tegerl/jabberwocky/rooms/castle/tower2", "up",
  });
