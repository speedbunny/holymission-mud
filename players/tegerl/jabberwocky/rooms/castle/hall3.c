...
long_desc=
    ...
    "To the north seems to be a holy place, but to the east you can here voices. To the west and the south the hall continues.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/castle/hall2", "west",
    "players/tegerl/jabberwocky/rooms/castle/king", "east",
    "players/tegerl/jabberwocky/rooms/castle/hall6", "south",
    "players/tegerl/jabberwocky/rooms/castle/chap", "north",
});
