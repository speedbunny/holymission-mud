...
long_desc=
    ...
    "To the southeast you can enter a tower, but to the west and the north the hall continues.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/castle/tower6", "southeast",
    "players/tegerl/jabberwocky/rooms/castle/hall5", "west",
    "players/tegerl/jabberwocky/rooms/castle/hall3", "north",
});
