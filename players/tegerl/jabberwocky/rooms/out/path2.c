...
long_desc=
    ...
    "To the north the forest lightens. Maybe this is a chance to get out of here. " +
    "It seems as if there would be a small cottage in the northwest, but you are not sure. " +
    "There are many more footprints and trails now.\n";

dest_dir=({
    "players/tegerl/jabberwocky/rooms/out/path1", "south",
    "players/tegerl/jabberwocky/rooms/out/clear", "north",
    });
