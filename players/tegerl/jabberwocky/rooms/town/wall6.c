...
long_desc=
    "This is the northwestern part of the town. " +
    "To the west and north is the city-wall, there is a road to the east and the south. " +
    "There are people on the street and they seem to be busy.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/town/street8", "east",
    "players/tegerl/jabberwocky/rooms/town/wall5", "south",
  });
