...
long_desc=
    ...
    "To the southeastern is the city-wall, to the northwest you can see a house entrance " +
    "There are people on the street and they seem to be busy.\n";
  
dest_dir=({
    "players/tegerl/jabberwocky/rooms/town/wall11", "north",
    "players/tegerl/jabberwocky/rooms/town/house6", "northwest",
    "players/tegerl/jabberwocky/rooms/town/wall9", "southwest",
  });
