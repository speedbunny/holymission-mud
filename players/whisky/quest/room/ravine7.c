...
reset(arg) {
  ...
  long_desc =
    ...
    "the south and west. A small path is leading further to the\n"+
    "north and east. There are some heavy stones lying on the bottom.\n";
  items =
    ({
     "rocks","Big grey rocks",
     "rock","A big grey rock",
     "path","A path leading further to the north and east",
