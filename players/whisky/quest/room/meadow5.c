...
reset(arg) {
   ...
   if (!mob)
   {
     mob = clone_object(MONST+"golden_dragon");
  ...
  long_desc =
    ...
    "To the west you see a little lake.\n";
  ...
  init() {
    ...
    swim2() {
     ...
     call_out("swim4",2);
      ...
      swim4() {
     write("You crawl up and find yourself in fromt of a big cave.\n");
     TP->move_player("into the lake#players/whisky/quest/room/rock");    
     }
