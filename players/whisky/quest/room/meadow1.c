...
reset(arg) {
  ...
  long_desc =
    "You have left the small path and entered a little, lit meadow.\n"+
    "The ground is soft and the grass is wet and high. There are\n"+
    "nearly any kind of flowers growing on this meadow and you can\n"+
    "see some big rocks to the west and east.\n";
  items =
    ({
     "rocks","Big grey rocks",
     "meadow","@@query_meadow@@",
     "rock","A big grey rock",
     "path","A small path leading further to the south, north, northwest and northeast",
