...
reset(arg) {
  ...
  long_desc =
    "You are standing at the end of the  little, lit meadow. It's a bit\n"+
    "darker here. The bottom is soft and the grass is wet and high.\n"+
    "There are nearly any kind of flowers growing on this meadow, \n"+
    "you can see some big rocks to the east and south and a path\n"+
    "leading into a dark forest to the north.\n";
  items =
    ({
     "rocks","Big grey rocks",
     "rock","A big grey rock",
     "path","A small path leading to the north",
     "meadow","@@query_meadow@@",
  ...
  dest_dir =
     ({
     PATH+"meadow10","south",
     PATH+"meadow11","southeast",
     PATH+"meadow9","southwest",
     PATH+"forest_entrance","north",
