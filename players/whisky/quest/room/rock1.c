...
reset(arg) {
  ...
  items =
    ({    
     ...
     "rock","Big dark rocks, with an entrance to a small cave to the north",
     "rocks","Some big rocks",
  ...
  north() {
   if (present("danahra",this_object())) {
    ...
    write("You leave into the cave.\n");
    TP->move_player("into the cave#players/whisky/quest/room/cave2");
