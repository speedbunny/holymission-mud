...
void reset(int arg)  
{
     ...
     long_desc = BS(
           ...
           "and northeast. It seems that you are on a crossroad leading further into "+
           "A strange town. There is a hot lake to the east.");
           
              
           
      items = ({
            "cave","The cave leads further to the northwest and northeast",
            ...
            "path","The path leads further to the northwest and northeast",
      ...
      dest_dir = ({
            PATH+"gnome16","northwest",
            PATH+"gnome10","southeast",            
            PATH+"gnome18","northeast"
               });
