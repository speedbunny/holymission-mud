...
void reset (int arg)
{
     ...
     long_desc = 
         ...
         "recognize that the walls are made of a shiny black stone, "+
         "and there are lighted torches fixed to the walls. North, "+
         "there is a big iron pole leading down into a big hole "+
         "from which you can hear human noises. On the right side "+
         "of the cave there is a net fixed on two large sticks. The "+
         "only way out would appear to be to the south.\n";
      ...
      items = ({
            ...
            "path","The path is dark leads back to the south",
     ...
     do_north() {
       ...
       write("\n\n################    YOU ARE FALLING   #################\n\n"+
             ...
             TP->move_player(" fast as a stone down into the hole#players/whisky/island/room/gnome3");
     ...
     do_slide ( arg ) {
        ...
        if (!arg || arg!="pole") {
            ...
            TP->move_player(" sliding down the pole#players/whisky/island/room/gnome3");
         }
