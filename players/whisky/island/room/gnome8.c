   ...
   if (filter_live(this_object()) < 1)
   {
    ...
    CM("gno5");
     ...
     long_desc = BS(
           ...
           "fixed to the walls. North there is a big iron pole leading down into a big "+
           "hole from where you can hear some human noises. On the right side of the "+
           "cave there is a big net fixed on two large sticks. The only way out seems "+
           "back to the west.");
           
      items = ({
            "cave","The cavern leads back to west",
            ...
            "path","The path is dark leads back to the west",
            ...
            "volcano","Well you are inside of it"
            });
     ...
     do_north() {
       ...
       write("\n\n################    YOU ARE FALLING   #################\n\n"+
             ...
             TP->move_player(" fast as a stone down into the hole#players/whisky/island/room/gnome9");
     ...
     do_slide ( arg ) {
        ...
        if (!arg || arg!="pole") {
            ...
            TP->move_player(" sliding down the pole#players/whisky/island/room/gnome9");
         }
