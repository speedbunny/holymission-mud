...
void reset(int arg) 
{
     ...
     long_desc = BS(
           ...
           "The air is really hot here. To the east you can see a hot lake and to "+
           "the north you can see a small BUILDING with some noise coming from.");
      ...
      items = ({
            ...
            "building","You can see a small building to the north, looks like a trader",
