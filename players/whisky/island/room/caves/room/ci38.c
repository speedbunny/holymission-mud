...
void reset(int flag)
{
     ...
     {
        set_light(0);
        short_desc = "At the eastern end of a big hallway";
        long_desc = BS(
        "You are standing at the eastern end of a big hallway. To the "+
        "east you can see the centre. All around you  there are huge "+
        "stone monoliths. You can see shadows moving behind them. "+
        "To the west you see a big stone wall covered with spots "+
        "of human blood.");
