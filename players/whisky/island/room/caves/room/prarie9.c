...
void reset(int flag)
{
     ...
     if (flag == 0)
     {
        ...
        long_desc = BS(
        "You are standing in a small open prarie next to some apple trees."+
        ...
        "cloud of steam. Your way to the east is blocked by "+
        "huge black heaps of rocks.");
        ...
        ({
         ...
         "trees","You see some big apple trees with sweet, red apples",
        });
        dest_dir = 
        ({
         PATH+"prarie8","west",
         PATH+"prarie4","southwest",
         PATH+"for5","north",
        });
     }
}
