...
reset(arg) {
  ...
  set_al(1000);
     ...
     set_aggressive(0);
     move_object(clone_object("players/whisky/garden/obj/shawl"),
     this_object());
  }
}
notify(str){ 
...
hug(str) {
 ...
 fuck(str) {
  if (str=="girl" || str=="little girl") {
   write("The little girl spread her legs and you give\n"+
          "her your full sexual power.\n"+
          "You feel now more experienced.\n"+
          "but lower on power.\n");
/* reduce_hit_points doesn't exist in player */
    this_player()->reduce_hit_points(random(20));
/* add_experience is an illegal call, it should be add_exp */
    this_player()->add_experience(1);
  return 1;
  }
}
 shake(str) {
 ...
 fondle(str) {
  if (str=="girl" || str=="little girl") {
  write("The girl moans: Oh wonderful, wanna fuck\n"+
        "gimme more please.\n");
  return 1;
  }
}
