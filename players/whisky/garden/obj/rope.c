...
/* 15-01-94 Dice copied this file into this dir directly when the file /players/whisky/garden/room/forest6.c gave problems
loading.
Someone removed rope.c from this dir. Am not sure wether it will surve the
same purpose.
*/
