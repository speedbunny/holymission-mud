...
void reset(int arg)
  ...
  "all directions.\n";
  smell = "The air fresh";
  dest_dir=({"players/kawai/areas/dwarves/village4","north",
  "players/kawai/areas/dwarves/village8","west",
  "players/kawai/areas/dwarves/village11","south",
  "players/kawai/areas/dwarves/village12","east"});
