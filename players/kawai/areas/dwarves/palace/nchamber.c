...
void reset(int arg)
  {if(!arg)
    ...
    smell = "The air fresh";
    dest_dir = ({"players/kawai/areas/dwarves/palace/nwalk","west",
    "players/kawai/areas/dwarves/palace/anteroom","southeast"});
    items = ({"tapestries","Large, woven designs hang from the ceiling",
    "tapestry","This one looks like it signifies the King's heritage",
