...
\n\
  ...
  around.   There are many stalagtites and stalagmites every where.  You can\n\
  hear bears all around you. \n\
\n\
");

dest_dir=({"players/iishima/area/rooms/cave2","west",
           "players/iishima/area/rooms/cave5","northeast",
           "players/iishima/area/rooms/cave7","southeast"});
...
clone_list = ({1, 2, "bat", "players/iishima/area/monsters/bat", 0,
               2, 1, "bear", "players/iishima/area/monsters/bear", 0});
::reset(arg);
