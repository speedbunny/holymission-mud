...
\n\
  ...
  the place where larger bears are usually found.  You can hear loud growling\n\
  from below you. \n\
\n\
");

dest_dir=({"players/iishima/area/rooms/cave9","south",
           "players/iishima/area/rooms/cave13","north",
           "players/iishima/area/rooms/cave12","down"});
...
clone_list = ({ 1, 3, "bear", "players/iishima/area/monsters/largebear", 0 });
