...
reset(arg) {
	...
	set_light(1);
	short_desc="Tendo Practice Room--Northeastern Area",
	long_desc=
	  "This is the northeastern area of the practice room. The\n"+
	  "floor is padded by mats, and mirrors run the length of\n"+
	  "the walls. There are some students practicing their kata.\n"; 
	dest_dir=({
	  AROOMS+"tendoa08","west",
	  AROOMS+"tendoa18","south",
	  AROOMS+"tendoa19","southwest",
	  AROOMS+"tendoa06","east",
		 });
	items=({ 
