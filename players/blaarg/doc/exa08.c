...
// Add drinks and food to the menu.
// The parameters are = name of item, cost, strength, type of item,
//     heal amount, and menu item (used in menu list and when it
//     is ordered).
// Excessive amounts will be nixed. Check with /doc/rules for
// appropriate values.
  add_item("beer", 20, 2, "alco", 5, "A mug of beer");
