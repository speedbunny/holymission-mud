/*
 *  Board Boots - for easy access to most of the boards on the Mud
 *  Edited by Mangla to eliminate the say for invis Wizards,
 *    and removed the guild_change for the jedi board.
 *  31-01-94 Added Barbarian and Vagabond Boards
 *  13-02-94 Removed guild_changes in monks, and sorted guilds
 *
 *  Elemental Tamina:
 *  27-09-94 Added new boards, and removed old ones,
 *           Cleaned the display of available Boards,
 *           Formatted the coding slightly
 *
 *  27-04-95 Added/Removed old and new boards.
 *
 */
...
string short()
{
  return "Bboots (Board boots V 1.3 - as updated by Tamina)"; 
}
...
"  (b 6) ... bje0..... Jedi Outer      |  (b 18) .. bfi ...Fighters Board\n"+
"  (b 7) ... bbr ..... Barbarian Wall  |  (b 19) .. bdr ......Druid Board\n"+
"  (b 8) ... bva ..... Vagabond board  |  (b 20) .. bm1 .....Mage's Outer\n"+
"  (b 9) ... bmd ..... Muds Ads Board  |  (b 21) .. bm2 .....Mage's Inner\n"+
...
"  ffind <name>, bsend <name>, so <object>");
     if (TP->LVL > 32) write (", imprison <name>");
     write ("\n");
}
...
void init () 
{
    ...
    AA ("goto_samu",    "bsa");  AA ("goto_m1",        "bm1");
    AA ("goto_new",    "bnew");  AA ("goto_m2",        "bm2");
    AA ("goto_druid",   "bdr");

    if (TP->LVL > 32)            AA ("imprison",  "imprison");
...
goto_board (string str) 
{
  switch (str) 
  {
    ...
    case "19":
    case "druid":    goto_druid(); return 1; break;
    case "20":
    case "m1":      goto_m1(); return 1; break;
    case "21":
    case "m2":      goto_m2(); return 1; break;
    case "22":
...
goto_thief ()    { SilentMove
  ("players/kryll/guild/hideout","thiefs guild"); return 1; }
goto_druid ()    { SilentMove
  ("players/sourcer/guild/room","druid's guild"); return 1; }
goto_fighter ()  { SilentMove
  ("players/capablanca/guild/restroom","fighters guild"); return 1; }
goto_jedi ()     { SilentMove 
  ("players/mangla/guild/inner","jedi inner"); return 1; }
goto_mage ()     { SilentMove
  ("players/llort/guild/tower/hallway","mages guild"); return 1; }
goto_m1()        { SilentMove
  ("players/llort/guild/tower/outer_chamber", "mages outer"); return 1; }
goto_m2()        { SilentMove
  ("players/llort/guild/tower/inner_chamber", "mages inner"); return 1; }
