...
#endif
        mazemap->set_read_file("/players/padrone/maze/holymap.txt");
...
reset(arg) 
{
    ...
    {
	set_light(1);
	short_desc = "Uglagrok's workroom";
        dest_dir =
        ({
            "players/padrone/maze/uglagroks_bathroom","north",
            "players/padrone/maze/maze31","west",
        });
        long_desc =
          "You are in a small room that seems to have been cut out from\n" +
