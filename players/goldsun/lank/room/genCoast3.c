...
reset(arg){
 if (!arg){
  ...
  items=({"sea","The sea is blue",
	 ...
	 "tall peak","A peak to the northwest.\n"
		  +"It is named Lankpeak and it is very tall",
	 "peak","A peak to the northwest.\n"
	      +"It is named Lankpeak and it is very tall",
	 "tall Lankpeak","A peak to the northwest",
	 "Lankpeak","The peak is very tall",
	 "mountains","The Lankbourg mountains to the northwest",
	 "Lankbourg mountains","The mountains to the northwest"
         });
