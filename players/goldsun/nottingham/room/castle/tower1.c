...
reset(arg){
 ...
 property=({"has_fire"});
 dest_dir=({"/players/goldsun/nottingham/room/castle/tower2","up", 
	    "/players/goldsun/nottingham/room/castle/throne","south",
   	    "/players/goldsun/nottingham/room/castle/prison1","down" });
