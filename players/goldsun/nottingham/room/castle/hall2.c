...
reset(arg){
 ...
 MAKE_DOORS("/players/goldsun/nottingham/room/castle/hall2","east",
          "/players/goldsun/nottingham/room/castle/private","west","steel",
          "no_code_902",
          "An oak door.\n", 1,0,0);
 

 dest_dir=({"/players/goldsun/nottingham/room/castle/tower2","north", 
   	    "/players/goldsun/nottingham/room/castle/hall3","south" });
 ...
 items=({ "candlesticks","They are made of iron",
	  ...
	  "carpet","A red carpet continues to the south"
        });
