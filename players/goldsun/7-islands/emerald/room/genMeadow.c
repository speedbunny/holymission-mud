...
if (!arg){
 ...
 long_desc=
  "You can see a beautiful island. High green grass is slowly waving in\n"+
  "the wind and you want to lie here and watch the clouds above.\n"+
  "Whole islands is hilly and grassy.\n";
