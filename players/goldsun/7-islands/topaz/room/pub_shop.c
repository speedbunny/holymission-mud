...
void reset(int arg) 
{
  ...
  "where Zuzana trades with stuff. You can also buy a drinks here.\n"+
  "There is a sign on the wall saying:\n"+
  "Shop commands: list, buy <item>, buy <number>\n"+
  "Pub commands : read menu, order <item>, order <number>\n");
   set_light(1);
   store = "/players/goldsun/7-islands/creta/room/main_store";
   keeper = "Zuzana";
   maxlist=35;
   
  items = ({"walls","The walls are made of mud bricks",
            "desk","It's a wooden desk",
            "bottom","It's made of spruce wooden lathes",
            "lathes","They are spruce wooden",
            "zuzana","She is standing behind the desk smiling friendly at you",
