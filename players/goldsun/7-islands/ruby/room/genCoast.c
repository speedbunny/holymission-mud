...
if (!arg){
 ...
 long_desc=
  ("You are standing on the rocky coast of the Ruby Island. The island\n"+
   "is large and high vulcano. Sea waves breaks to millions drops on the\n"+
   "boulders and you can feel them on your face.\n"
  );
