...
reset(arg) {
   ...
   long_desc = "You stand at the east end of a beautiful courtyard.\n"+
             ...
             "the courtyard continues, while to the north and south\n"+
             "castle walls.\n";
   smell = "The air is sweet";

   dest_dir = ({"players/goldsun/guild/room/centeryard","west",
	        "players/goldsun/guild/room","east"
		});
   ...
   "palace","It's Carmaalot.  Its white and nicely decorated"});
