...
/* skill system, copied  from /players/whisky/guild/skill_system  */
/* Thanks to Whisky 						  */	
...
/*
  ...
  Returns: 0 or the actual skill of the knight 
                                                   */
...
/*
  ...
  Returns: the new practice sessions of the knight
                                                   */
...
int raise_skill(object mob,string mskill,int boni)
{
   int newskill;
    ...
    if (newskill > 100)    /* hehe check for max skill change it !!!*/
        newskill = 100;
    if (newskill < 1)      /* check for min skill */
        newskill = 1;
