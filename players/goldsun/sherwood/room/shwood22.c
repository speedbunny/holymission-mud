...
reset(arg){
 ...
 long_desc=("You are at the edge of the Sherwood forest. The trees and bushes"
           ...
           +"everywhere. From time to time you can hear an animal sound from"
                 +" the forest.\n"
           +"To the south and west you can see a steep hill covered by the moss"
                  +" and\n"
          +"small bushes.\n");

 smell="You smell common damp forest air.";
 dest_dir=({"/players/goldsun/sherwood/room/shwood21", "north",
            "/players/goldsun/sherwood/room/shwood18", "east",
           "/players/goldsun/sherwood/room/shwood29", "northwest"});
