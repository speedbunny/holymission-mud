...
heart_beat(){
 ...
 if (counter>5){
   counter=0;
   tell_object(find_player("goldsun"),"DEBUG of : "+file_name(TO)+"\n");
   tell_object(find_player("goldsun"),"Counter is 25..\n");
   tell_object(find_player("goldsun"),"Is leader=="+is_leader+"\n");
   wandering();
 } 
...
void check(){
 ...
 write("This soldier is "+is_leader+" (1 = is leader, -1 = has own leader, 0 = not)\n");
