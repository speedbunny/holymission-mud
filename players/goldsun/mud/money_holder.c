...
int _ravanata(string amo)
{
 ...
 if (sscanf(amo,"%d",num)==1)
 {
   ...
   {
      write("A small ice duck jumps from the chest and duckes you:\n");
      write("Duck duckes you: Uf. There is no room for this amount.\n");
      write("Ice duck jumps back to the chest.\n");
      return 1;
   }
   write("A small ice duck jumps from the chest and takes money from you.\n");
   write("Ice duck jumps back to the chest.\n");
   amount+=num;
...
int i, count;
 ...
 for(i=0;i<count;i++)
 {
   ...
   else write("Duck duckes you: Uf. There is no room for this amount.\n");
