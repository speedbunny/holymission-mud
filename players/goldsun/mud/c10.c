...
i=0;
    ...
    if(!board) {
       board = clone_object("/players/whisky/obj/board");
    ...
    long_desc =  BS(
      "This is the monks meditation-room of the chapel. Here the monks "
     +"have their peace apart from the rest of the world. There is a board "
        + "hanging on the wall where the monks can state their desires. " 
        + "A little corridor leads further to the south. There is a "+
          "small sign fixed to the wall.");
    items = ({ 
...
fcn_read(string arg)
{
 ...
 "Monks are typically for having an own follower. The followers\n"+
