...
/* SA(me->query_attack->query_name()+" tries to hit "+
 capitalize(me->query_real_name())+" but "+
 me->query_possessive()+" horse "+mess+" and parries the main attack.\n");
*/ 
...
{
 return me->move_player(dir_dest, optional_dest_ob, raw, "arrives on "+me->query_possessive()+" horse.");
}
