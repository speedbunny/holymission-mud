...
/* 040897: Modified to use the new XP system */
...
int bexp,gexp;
  ...
  bexp=this_player()->query_min_exp_for_level();
  gexp=this_player()->query_exp_for_next_level();
  if(str=="min") {
  ...
  if(gexp<0) {
    write("You have all the experience you need!\n");
    return 1;
  }
