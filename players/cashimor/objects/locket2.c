...
/* 200793: Ethereal Cashimor: New string structure */
...
query_auto_load() { 
  return "/players/cashimor/objects/locket:"+lname;
} 
  ...
  switch(global) {
    case 0:
      switch(i) {
        case "Tn": return "You";
        case "st": return "";
        case "on": case "On": return who->query_name();
        case "oo": return who->query_objective();
        case "ts": return "yourself";
        case "p": case "tr": return "you";
        case "tp": return "your";
        case "oP": return who->query_name()+"'s";
        case "so": return "s";
        case "sT": return "are";
      }
    case 1:
      switch(i) {
        case "Tn": return this_player()->query_name();
        case "st" : return "s";
        case "on": case "oo": case "p": return "you";
        case "ts": return this_player()->query_objective()+"self";
        case "tp": return this_player()->query_possessive();
        case "oP": return "your";
        case "On": return "You";
        case "so": return "";
        case "tr": return this_player()->query_pronoun();
        case "sT": return "is";
      }
    case 2:
      switch(i) {
        case "Tn": return this_player()->query_name();
        case "st": case "so": return "s";
        case "on": case "On": return who->query_name();
        case "oo": return who->query_objective();
        case "ts": return this_player()->query_objective()+"self";
        case "p" : return "them";
...
do_text(str) {
  global=0;
  write(lw(process_string(str)));
  global=1;
  tell_object(who,lw(process_string(str)));
  global=2;
  say(lw(process_string(str)),who);
}
...
string wrt,tll,sy;
  ...
  switch(query_verb()) {
    case "lhold":
      text="@@n|Tn@@ hold@@n|st@@ @@n|on@@ close, never wanting to let "
         + "@@n|oo@@ go.\n";
      break;
    case "lwrestle":
      text="Suddenly, a large gooey pool of mud appears! @@n|Tn@@ "
         + "throw@@n|st@@ @@n|on@@ and @@n|ts@@ into it and start@@n|st@@ to "
         + "wrestle. Both of @@n|p@@ slip and slide around until both of "
         + "@@n|p@@ are totally covered in mud. Is that what being a "
         + "mud-a-holic is all about?\n";
      break;
    case "tu":
      text="@@n|Tn@@ stick@@n|s@@ @@n|tp@@ thumb up in @@n|oP@@ direction and "
         + "say@@n|st@@: Alright man!\n";
      break;
    case "lbonk":
      text="@@n|Tn@@ dance@@n|st@@ around @@n|on@@ and bonk@@n|st@@ @@n|oo@@ "
         + "on the head for being so silly! @@n|On@@ say@@n|so@@: Oiiff!\n";
      break;
    case "hf":
      text="@@n|Tn@@ run@@n|st@@ up to @@n|on@@ and high-five@@n|st@@ @@n|oo@@"
         + " with a loud *smack*.\n";
      break;
    case "banana":
      text="Something grows in @@n|tp@@ pants when @@n|tr@@ look at "
         + "@@n|on@@. @@n|On@@ wonder@@n|so@@ if that's a banana growing in "
         + "@@n|tp@@ pocket or if @@n|tr@@ @@n|sT@@ just happy to see "
         + "@@n|oo@@?"
