...
status bold_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[1m" + str + "[0m \n");
...
status flash_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[5m" + str + "[0m \n");
...
status rev_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[7m" + str + "[0m \n");
...
status und_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[4m" + str + "[0m \n");
...
status boldf_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[1m"+"[5m" + str + "[0m \n");
...
status revf_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[7m"+"[5m" + str + "[0m \n");
...
status undf_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[4m"+"[5m" + str + "[0m \n");
...
status boldu_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[1m"+"[4m" + str + "[0m \n");
...
status boldr_tell (string all)
{
  ...
  if (all)
  {
    ...
    if (str)
    {
      ...
      if (ob)
      {
        tell_object (ob,"Thorm tells you: " + "[1m"+"[7m" + str + "[0m \n");
