...
goto_pflame ()   { SilentMove
    ("players/mangla/rooms/player_flame","player flame"); return 1; }
...
goto_psheriff () { SilentMove
    ("players/exos/rooms/player_office","sheriff's"); return 1; }

goto_thief ()    { SilentMove
    ("players/blade/guild/hideout","thiefs guild"); return 1; }
goto_fighter ()  { SilentMove
    ("players/gareth/guild/rooms/restroom","fighters guild"); return 1; }
goto_jedi ()     { 
...
goto_wflame ()   { SilentMove
    ("players/mangla/rooms/wizard_flame","wizards flame"); return 1; }
...
goto_wsheriff () { SilentMove
    ("players/exos/rooms/wiz_office","wizards sheriff's"); return 1; }
