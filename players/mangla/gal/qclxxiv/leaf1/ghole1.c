...
extra_reset(arg) {
	...
	if (!gr2) {
		gr2= clone_object("players/qclxxiv/grabbit1");
	...
	if (!gr4) {
		gr4= clone_object("players/qclxxiv/grabbit1");
...
THREE_EXIT( 
		"players/qclxxiv/leaf1/l6","up",
		"players/qclxxiv/leaf1/ghole2","east",
		"players/qclxxiv/leaf1/ghole3","down",
       	 "A small grabbit hole",
       	 "You are in a small grabbit hole. An opening leads up, tunnels\n"+
		"lead down and to the east.\n" , 1)
