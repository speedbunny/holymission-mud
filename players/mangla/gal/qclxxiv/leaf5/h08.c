...
THREE_EXIT( REGION+"h07", "northwest",
REGION+"l24", "west",
REGION+"h09", "southeast",
"Inside a dark maze",
"Inside a dark maze.\n",
0 )
...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h08","east","players/qclxxiv/leaf5/q08","west","copper","q08","An old oaken door, on it is engraved: *ou&m.\n",1,0,1)
