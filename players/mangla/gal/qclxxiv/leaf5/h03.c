...
THREE_EXIT( REGION+"l23", "north",
REGION+"h02", "northwest",
REGION+"h04", "southeast",
"Inside a dark maze",
"Inside a dark maze.\n",
0 )
...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h03","south","players/qclxxiv/leaf5/q03","north","copper","q03","An old oaken door, on it is engraved: *uom&&.\n",1,0,1)
