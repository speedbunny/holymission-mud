...
TWO_EXIT( REGION+"h06", "northwest",
REGION+"h08", "southeast",
"Inside a dark maze",
"Inside a dark maze.\n",
0 )
...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h07","east","players/qclxxiv/leaf5/q07","west","copper","q07","An old oaken door, on it is engraved: *uo&o.\n",1,0,1)
