...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h06","east","players/qclxxiv/leaf5/q06","west","copper","q06","An old oaken door, on it is engraved: *!o&m.\n",1,0,1)
