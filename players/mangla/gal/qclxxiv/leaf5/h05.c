...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h05","south","players/qclxxiv/leaf5/q05","north","copper","q05","An old oaken door, on it is engraved: *um&&.\n",1,0,1)
