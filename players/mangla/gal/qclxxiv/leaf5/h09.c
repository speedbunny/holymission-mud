...
TWO_EXIT( REGION+"h08", "northwest",
REGION+"h10", "southeast",
"Inside a dark maze",
"Inside a dark maze.\n",
0 )
...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h09","east","players/qclxxiv/leaf5/q09","west","copper","q09","An old oaken door, on it is engraved: *uo&.\n",1,0,1)
