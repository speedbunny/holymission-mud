...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h10","east","players/qclxxiv/leaf5/q10","west","copper","q10","An old oaken door, on it is engraved: *!m.\n",1,0,1)
