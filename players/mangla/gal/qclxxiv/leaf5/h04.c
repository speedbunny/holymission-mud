...
TWO_EXIT( REGION+"h03", "northwest",
REGION+"h05", "southeast",
"Inside a dark maze",
"Inside a dark maze.\n",
0 )
...
extra_reset(arg) {
   if (arg) return;
	MAKE_DOORS("players/qclxxiv/leaf5/h04","south","players/qclxxiv/leaf5/q04","north","copper","q04","An old oaken door, on it is engraved: *uo!m&.\n",1,0,1)
