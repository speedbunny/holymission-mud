...
#define MINERAL "micropyrith"
#define MINLOOK "A shiny and metallic pale brass-coloured piece of mineral.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/mine4","up",
"players/qclxxiv/leaf7/mine6","down",
