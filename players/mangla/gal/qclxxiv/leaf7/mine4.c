...
#define MINERAL "carbomarine"
#define MINLOOK "A greenish blue transparent rough crystal.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/mine3","up",
"players/qclxxiv/leaf7/mine5","down",
