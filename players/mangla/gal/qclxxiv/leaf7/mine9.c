...
#define MINERAL "carbosapphire"
#define MINLOOK "A deep purplish blue translucent crystal.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/mine8","up",
"players/qclxxiv/leaf7/mine10","down",
