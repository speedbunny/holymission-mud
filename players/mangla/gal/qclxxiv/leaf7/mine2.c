...
#define MINERAL "lilimond"
#define MINLOOK "A dense black and apparently hard lump of stone.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/mine1","up",
"players/qclxxiv/leaf7/mine3","down",
