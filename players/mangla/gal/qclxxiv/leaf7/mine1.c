...
#define MINERAL "carbonyx"
#define MINLOOK "A piece of stone, banded with a large range of colours.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/r8","up",
"players/qclxxiv/leaf7/mine2","down",
