...
TWO_EXIT( "players/qclxxiv/leaf7/r3","southwest",
"players/qclxxiv/circular/circ7","northeast",
"Between some trees",
"It's weird, but in here there are actually trees growing....and to the\n"+
"south and southwest apparently there is a wood. You hear birds chirping.\n"+
