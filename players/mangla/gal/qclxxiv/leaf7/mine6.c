...
#define MINERAL "gnomonyx"
#define MINLOOK "A lump of stone, banded with layers of various shades of colours.\n"
...
TWO_EXIT( "players/qclxxiv/leaf7/mine5","up",
"players/qclxxiv/leaf7/mine7","down",
