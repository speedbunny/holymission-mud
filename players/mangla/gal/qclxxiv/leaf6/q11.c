...
TWO_EXIT( LEAF+"q12","southwest",
           	HOME+"circular/circ6","northeast",
       	 "A smudgy, badly kept path",
"A smudgy, badly kept path, covered with puddles. Mildew grows on everything\n"+
"here. It smells horrible here.\n", 1)
