...
obj_1 = clone_object( "players/qclxxiv/door");\
obj_2 = clone_object( "players/qclxxiv/door");\
...
#define MAKE_MYKEY( obj_variable, key_type, key_code) \
obj_variable = clone_object( "players/qclxxiv/mykey"); \
call_other( obj_variable, "set_key_data", key_type + " " + key_code);
