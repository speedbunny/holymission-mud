...
ONE_EXIT( HOME+"leaf3/s3","south",  "A small place", 
"A small place in front of an old decayed house. A number- and a name-plate\n"
+"are on it, right of the old door.\n",
1)
...
read(arg) {
	...
	if (arg=="name-plate") {
		write( "From what's left you read: P. J..sen.\n");
		return 1;
	}
	return 0;
}
...
extra_reset(arg) {
	...
	items = ({
		...
		"number-plate", "1",
		"name-plate", "From what's left you read: P. J..sen",
