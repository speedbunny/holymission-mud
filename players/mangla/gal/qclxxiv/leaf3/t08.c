...
read(arg) {
	...
	if (arg=="name-plate") {
		write(
	"Some letters have disappeared. Yet you can still read: R. Roos.\n");
		return 1;
	}
	return 0;
}
...
extra_reset(arg) {
	if (arg) return;
    /* set_nodig(1); */
	MAKE_DOORS("players/qclxxiv/leaf3/t08","house","players/qclxxiv/leaf3/h08","west","silver","h08","This is an old oaken door.\n",1,0,1)
