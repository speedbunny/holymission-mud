...
FOUR_EXIT( HOME+"leaf3/s3","southwest",  HOME+"leaf3/s05","northeast",
			HOME+"leaf3/tohouse3", "north", HOME+"leaf3/tohouse4", "east",
"A small street", 
...
+"Apparently the one to the north is a pub of some kind.\n",
1)
