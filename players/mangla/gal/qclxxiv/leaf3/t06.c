...
read(arg) {
	...
	if (arg=="name-plate") {
		write(
	"Some letters have disappeared. Yet you can still read: Capt. Wha.e.\n");
		return 1;
	}
	return 0;
}
...
extra_reset(arg) {
	if (arg) return;
    /* set_nodig(1); */
	MAKE_DOORS("players/qclxxiv/leaf3/t06","house","players/qclxxiv/leaf3/h06","west","yellow-copper","h06","This is an old oaken door.\n",1,0,1)
