...
ONE_EXIT( REGION+"s05", "south",
"A small place", 
"A small place in front of an old house. A number- and a name-plate are on\n"
+"it, left to the old door. Large letters painted above the door read:\n"
+"Dr. Sp.cht.\n" , 1)
...
read(arg) {
	...
	if (arg=="name-plate") {
		write(
		"Some letters have disappeared. Yet you can still read: Dr. Spe..t.\n");
		return 1;
	}
	return 0;
}
...
extra_reset(arg) {
	if (arg) return;
    /* set_nodig(1); */
	MAKE_DOORS("players/qclxxiv/leaf3/t05","house","players/qclxxiv/leaf3/h05","south","red-copper","h05","This is an old oaken door.\n",1,0,1)
