int see(string str) {            /* You can see in the dark */
    ...
    set_light(5);
    write("Dark object look.\n");
    if(lookat=present(str,ENV(TP))) {
        lookat->long();
        write("In the environment.\n");
    }
    else if(lookat=present(str,TP)) {
        lookat->long();
        write("In the players inventory.\n");
    }
    else {
...
int inv() {                   /* you can see your inventory */
