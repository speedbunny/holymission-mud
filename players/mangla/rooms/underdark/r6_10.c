...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay. The light\n" +
              "from your light sources does not reach quite reach into\n" +
              "the corners, the shadows seem alive.\n\n";
    ...
    dest_dir=({UNDER + "r6_9","south",
               UNDER + "r7_10","east"
             });

    clone_list = ({ 1, 2, "cloaker", MNST+"under/cloaker", 0,
                 });
