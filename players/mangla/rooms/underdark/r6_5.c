...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay. The bats on\n" +
              "the ceiling seem to be resting, but not all. The floor here\n" +
              "is covered with guano.\n\n";
    ...
    dest_dir=({UNDER + "r6_4","south",
               UNDER + "r7_5","east"
             });

    clone_list = ({ 1,20, "bat", MNST+"under/bat", 0,
                 });
