...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay. The screeching\n" +
              "of the bats nearly deafens you. Some appear to be restless.\n" +
              "As with the whole section, the floor is coated in guano.\n\n";
    ...
    dest_dir=({UNDER + "r8_5","east",
               UNDER + "r6_5","west",
               UNDER + "r7_6","north"
             });

    clone_list = ({ 1,25, "bat", MNST+"under/bat", 0,
                 });
