...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay. The air is\n" +
              "moist here. So much so that you start to sweat from\n" +
              "just the humidity it contains.\n\n";
