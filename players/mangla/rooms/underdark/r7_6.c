...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay. This appears\n" +
              "too be where most of the bats stay, and they do not look\n" +
              "happy to see you. Your feet squish as you pass through.\n\n";
    ...
    dest_dir=({UNDER + "r7_5","south"
             });

    clone_list = ({ 1, 40, "bat", MNST+"under/bat", 0,
                 });
