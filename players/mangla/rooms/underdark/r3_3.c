...
reset(arg) {
    ...
    long_desc="You see all around you only black, your light source\n" +
              ...
              "where even the air reeks of death and decay, but moisture\n" +
              "seems to have raised this stench to totally undesirable levels.\n" +
              "The sweat beads on your brow.\n\n";
