...
reset(arg) {
    ...
    long_desc="This rocky and barren terrain is a testament to the\n" +
              ...
              "depressed by the grey surroundings. There are numerous\n" +
              "burn marks leading out from the cave you can now see here.\n";
    ...
    dest_dir=({ROOM + "mount/rock13","north",
//               ROOM + "mount/rock0","up",
               ROOM + "mount/rock11","west",
               ROOM + "mount/rock2","down",
               ROOM + "mount/cave","enter",
             });
