...
void reset(int arg)
  {if(!arg)
    ...
    "/room/well","north",
    "/players/warlord/quest1/room3","south",
    "/players/warlord/quest1/room5","east",
    "/players/warlord/quest1/room4","west"});}
  exit_num=random(4);}
...
status block()
  ...
  ((dir=="east")&&(exit_num==2))||
  ((dir=="west")&&(exit_num==3)))
    {this_player()->move_player(dir+"#/players/warlord/quest1/room8");
    return 1;}
  else
