...
void reset(int arg)
  {if(!arg)
    ...
    long_desc=
    "Grey mist swirled around your feet as you walk down this narrow tunnel.  "+
    ...
    "/players/warlord/quest1/room3","north",
    "/players/warlord/quest1/room1","south",
    "/players/warlord/quest1/room2","east",
    "/room/well","west"});}
  exit_num=random(4);}
...
status block()
  ...
  ((dir=="east")&&(exit_num==2))||
  ((dir=="west")&&(exit_num==3)))
    {this_player()->move_player(dir+"#/players/warlord/quest1/room4");
    return 1;}
  else
