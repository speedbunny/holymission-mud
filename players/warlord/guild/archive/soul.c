/*
  Changed by Dice 23-06-93
   I removed all capitals in the spells for players, attacked objects
   and for spectators.
********************************************************************
  Changed by Moonchild 140793
  Removed "song" and "sign"
*********************************************************************
  Matt 8-13-93: Changed guild-talk to use filter_array(), also line-wrapped
*********************************************************************
*/
/* #################################################################
...
/* 06.30.93 Airborne - Corrections made to the extra_look.
    Changed pronouns to possessives where needed and removed offensive materials. */

/*93-10-17 Herp: chat daemon */
...
#define FORMULA_CHOKE   ((TPD/3)+random(50))
...
help(str) {
    ...
    if(sizeof(explode(str," "))==1 && file_size("players/whisky/guild/helpdir/"+str)) {
