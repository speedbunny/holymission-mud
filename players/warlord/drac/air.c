...
long_desc = "This room looks like it was once the throne room for a king.\n"
       + "Light eminates from the walls giving this room a strange glow.\n"
...
items = ({ "throne", "A golden throne fit for a king",
	   "curtains", "Long black curtain that show no sign of age",
...
move(str){
   ...
   switch(str){
	...
	move_object(this_player(), "/players/airborne/temple/levelb/hidden");
   return 1;
