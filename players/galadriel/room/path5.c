...
reset(arg) {
  ...
  long_desc="You are on a small path along the river. To the north and\n"
        + "east yo see some bushes. To the west is the river.\n"
        + "On the other side of the river you can see a water mill.\n";
  dest_dir=({PATH+"path4","northwest",
        PATH+"path6","south"});
  mill_desc="A large watermill on the other bank of the river";
  items=({
        "river","The river quietly flows from the northwest to the south",
        "mill",mill_desc,
        "watermill",mill_desc,
