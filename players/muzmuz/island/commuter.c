...
{
     write(
     "This is the Cargo junk which transfers adventurers to the island\n"+
     "of death.\n");
}
   ...
   object env;
    ...
    {   
     if (this_player()->query_level()< 5) {
        ...
        "The captain says: Hey, you better gain some more levels before I\n" +
        "bring you there ! Cheer up, it is to your best !\n\n" +
        "The captain smiles at you compassionately.\n");
        return 1; }
