...
int id(string arg)
{
   switch(arg)
   {
    ...
    return 1;
    case "slot":
     write("The slot is big enough to insert one gold coin. There is\n"+
 ...
 init() {
  ...
  do_insert(arg) {
     ...
     what = (({"coin","1 coin","1 gold coin","one coin","one gold coin","gold coin"}));
    ...
    if (member_array(arg,what)==-1)
  {
      ...
      return ( 0 );
     } else if (player->query_money() < 1) {
        notify_fail("You don't have that much money.\n");
      return ( 0 );
     } else {
       tell_object(this_player(),
          "\nYou insert 1 copper coin. The coin hits the balance.\n\n");
...
start_box(object player) {
 ...
 win(object player) { 
    in_play = 0;
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 8 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,8);
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 13 coins.\n");  
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,13);
     pot=pot-(6);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 14 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,14);
     pot=pot-(7);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 22 coins.\n");  
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,22);
     pot=pot-(11);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 12 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,12);
     pot=pot-(6);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 3 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,3);
     pot=pot-(1);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 4 coins.\n");  
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,4);
     pot=pot-(2);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 2 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,2);
     pot=pot-(1);
     }
     ...
     tell_object(player,
     "A small hole in the box opens and a gnomish hand gives you 10 coins.\n"); 
     SAY("A small hole in the big box opens and a hand reaches out.\n");
     MONEY_ADD(player,10);
     pot=pot-(5);
     }
