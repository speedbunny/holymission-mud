#define COMS ({"say","monk","tell","ring","help","mt","who","score","look",\
               "rwhere","alias","monk/","m/","ering","i","mood","l","exa",\
               "mskills","smile","finger","attr","chat","chat/","reply",\
               "retell","monk:","m:","c:","remt",})

#define LEVEL (environment()->query_level() + 1)
#define FORM ((100 + LEVEL * 15) / (100 + LEVEL))
