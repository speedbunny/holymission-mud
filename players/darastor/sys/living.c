...
/* Sauron: Commented out... do we really need to log this?
...
change.
*/
varargs nomask string query_real_name(int flag) {
  if(flag)
    return capitalize(name);
  else
    return name;
...
the living.
*/
varargs string query_gender_string(int flag) {
  string tmp;

  switch(gender) {
    case 0:  tmp="neuter"; break;
    case 1:  tmp="male";   break;
    case 2:  tmp="female"; break;
    default: tmp="male";   break;
  }
  if(flag)
    tmp=capitalize(tmp);
  return tmp;
...
*/
varargs string query_pronoun(int flag) {
  string tmp;

  switch(gender) {
    case 0:  tmp="it";  break;
    case 1:  tmp="he";  break;
    case 2:  tmp="she"; break;
    default: tmp="he";  break;
  }
  if(flag)
    tmp=capitalize(tmp);
  return tmp;
...
living.
*/
varargs string query_possessive(int flag) {
  string tmp;

  switch(gender) {
    case 0:  tmp="its"; break;
    case 1:  tmp="his"; break;
    case 2:  tmp="her"; break;
    default: tmp="his"; break;
  }
  if(flag)
    tmp=capitalize(tmp);
  return tmp;
...
living.
*/
varargs string query_objective(int flag) {
  string tmp;

  switch(gender) {
    case 0:  tmp="it";  break;
    case 1:  tmp="him"; break;
    case 2:  tmp="her"; break;
    default: tmp="him"; break;
  }
  if(flag)
    tmp=capitalize(tmp);
  return tmp;
