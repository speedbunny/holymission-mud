...
if (!arg) {
 ...
 clone_list=({1,1,"tree","/players/goldsun/sherwood/monster/kiltree",0,
             });
 set_light(0);
 short_desc=("Sherwood");
 ...
 dest_dir=({"/players/goldsun/sherwood/room/shwood16", "south",
           "/players/goldsun/sherwood/room/shwood14", "north",
           "/players/goldsun/sherwood/room/shwood10", "east"});
