...
reset(arg){
 ...
 long_desc=("You are on a large hill. There are small bushes and green moss"
		+" around you.\n"
           +"In front of you there is a small cave.\n"
           +"From time to time you can hear an animal sound from"
                 +" the forest.\n");

 smell="You smell common damp forest air.";
 dest_dir=({"/players/goldsun/sherwood/room/shwood35", "down",
           "/players/goldsun/sherwood/room/hill1", "up", 
           "/players/goldsun/sherwood/room/shwood39", "south"});
 ...
 items=({"green moss","The moss is really green",
	 ...
	 "small cave","The cave looks dangerous",
...
climb(str){
   ...
   write("Uf.\n");
   write("Uf.\n");
   write("You climbs up the hill.\n");
   this_player()->move_player("up#/players/goldsun/sherwood/room/hill1");
   }
   else
    if (str=="down" || str=="hill down"){
     write("You climb down the hill.\n");
     this_player()->move_player("down#/players/goldsun/sherwood/room/shwood35");
    }
    else {
...
enter(str){
 if (str=="cave" || str=="small cave"){
  ...
  this_player()->move_player("into the cave#/players/goldsun/sherwood/room/hillcave");
  }
  else{
