...
/*
 * Percentage of max quest points needed to make wiz, for new quest system 
 * written by Moonchild. QUEST_PERCENT_FOR_WIZ should gradually be reduced
 * as new quests enter the game, but should probably never go below 80.
 */

#define QUEST_PERCENT_FOR_WIZ   85
