...
/* shore.c recoded the rooms to room.c Whisky */
...
#define ITEMS ({\
        ...
        "magetower","You see a big, ruined tower on the isle"+\
...
#define DESC\
        ...
        "Lake. Out in the centre of the clear, blue lake is the grassy " +\
        "green Isle of Magi with the high, ruined magetower of Arcanarton. "
...
int fcn_fish()
{
   object fi;
    ...
    if (!present("rod",this_player()) || count > 10)
    {
        notify_fail("You need a fishing rod to catch a fish.\n" +
                    "And if you have one, the lake is out of fishes.\n");
        return 0;
    }
