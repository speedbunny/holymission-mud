...
int query_mail(int silent) {
  ...
  if(new_mail)
    new = " NEW";
  writelw("There is" + new + " mail for you in the post office "+
...
string query_mail_string() {
  ...
  return ("There is" + new + " mail for you in the post office "+
          "(north of the village square).\n");
}
