...
void reset(int arg) {
  ...
  long_desc =
    ...
    "travel to the south and east. @@extra_look_forest@@ As you "+
    "look at the forest, you see that small patches of mushrooms "+
    "have sprouted. There is a town wall to the west.\n";
