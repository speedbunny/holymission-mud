...
void reset(int arg) {
    ...
    long_desc="The eastern edge of this deserted open plain " +
              "is bordered by a river here. Towards the west, " +
              "you can see the disintegrating remains of an " +
              "old ruined building. You could also clamber " +
              "down to the crumbling river bank.\n";

    dest_dir=({
                "room/ruin", "west",
                "players/moonchild/trollslayer/river2", "down",
             });

    items=({ "river", "The river looks some ten feet below you. " +
    ...
    clone_list = ({ 1, 1, "frog", "obj/monster",
                     ({ "set_name", "frog",        
                        "set_level", 1,
                        "set_wc", 4, 
                        "set_frog", 1,
                        ...
                        "set_long",         
                        "A cute little frog. It looks rather friendly.\n", }),
