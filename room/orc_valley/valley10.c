...
#define WEAPONS   ({"cleaver","bloodaxe","waraxe","halberd"})
 
void reset(int arg) {
  clone_list = ({
    1, 4, "huge orc", "obj/monster", ({
      "set_name", "huge orc",
      "set_race", "orc",
      "set_alt_name", "orc",
      "set_level", 16+random(21),
  ...
  dest_dir = ({
    ORC_VALLEY + "valley09", "east",
    ORC_VALLEY + "valley11", "west",
  });
