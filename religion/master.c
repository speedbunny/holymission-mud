/* Patience, May 1993:
  ...
  12/18/94 Tatsuo: added Crom for Barbarians
  01/09/94 Tatsuo: added Shinto for Samurai
  02/18/95 Airborne: Fixed move of Shinto religion.
*/
...
reset(arg) {
  ...
  if(!arg) {
    ...
    churches=({"/room/church","/players/patience/ezo/coast/jingu",
      ...
      "/players/apollo/guild/rooms/crag",
      "/players/haplo/guild/shrine",
      "/players/goldsun/religion/quercus_cave",
      "/players/patience/honshu/shrine/inner_shrine"});
    prays=({"religion/master","religion/master","religion/master",
            "religion/master","religion/master","religion/master",
            "religion/master",
            "players/patience/honshu/shrine/inner_shrine"});
  }
}
